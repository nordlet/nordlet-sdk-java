...
public final class PostV1FilesUploadResponse {
  ...
  private PostV1FilesUploadResponse(String id, String entity, Optional<String> entityId,
  ...
  public static final class Builder implements IdStage, EntityStage, FileNameStage, MimeTypeStage, SizeBytesStage, Sha256Stage, StorageKeyStage, CreatedAtStage, _FinalStage {
    ...
    public PostV1FilesUploadResponse build() {
      return new PostV1FilesUploadResponse(id, entity, entityId, fileName, mimeType, sizeBytes, sha256, storageKey, createdAt, additionalProperties);
    }
