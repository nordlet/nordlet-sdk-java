...
@JsonDeserialize(
    builder = PostV1CaptureDocumentsConfirmRequestLinesItem.Builder.class
)
public final class PostV1CaptureDocumentsConfirmRequestLinesItem {
  ...
  private final Optional<PostV1CaptureDocumentsConfirmRequestLinesItemQuantity> quantity;
  ...
  private PostV1CaptureDocumentsConfirmRequestLinesItem(Optional<String> itemId,
      Optional<String> description, Optional<String> unit,
      Optional<PostV1CaptureDocumentsConfirmRequestLinesItemQuantity> quantity,
  ...
  public Optional<PostV1CaptureDocumentsConfirmRequestLinesItemQuantity> getQuantity() {
    return quantity;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CaptureDocumentsConfirmRequestLinesItem && equalTo((PostV1CaptureDocumentsConfirmRequestLinesItem) other);
  }
  ...
  private boolean equalTo(PostV1CaptureDocumentsConfirmRequestLinesItem other) {
  ...
  public static final class Builder {
    ...
    private Optional<PostV1CaptureDocumentsConfirmRequestLinesItemQuantity> quantity = Optional.empty();
    ...
    public Builder from(PostV1CaptureDocumentsConfirmRequestLinesItem other) {
    ...
    public Builder quantity(PostV1CaptureDocumentsConfirmRequestLinesItemQuantity quantity) {
    ...
    public PostV1CaptureDocumentsConfirmRequestLinesItem build() {
      return new PostV1CaptureDocumentsConfirmRequestLinesItem(itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, projectId, accountCode, additionalProperties);
    }
