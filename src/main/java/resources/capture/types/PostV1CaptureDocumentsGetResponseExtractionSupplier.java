...
@JsonDeserialize(
    builder = PostV1CaptureDocumentsGetResponseExtractionSupplier.Builder.class
)
public final class PostV1CaptureDocumentsGetResponseExtractionSupplier {
  ...
  private PostV1CaptureDocumentsGetResponseExtractionSupplier(Optional<String> name,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CaptureDocumentsGetResponseExtractionSupplier && equalTo((PostV1CaptureDocumentsGetResponseExtractionSupplier) other);
  }
  ...
  private boolean equalTo(PostV1CaptureDocumentsGetResponseExtractionSupplier other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1CaptureDocumentsGetResponseExtractionSupplier other) {
      name(other.getName());
      code(other.getCode());
    ...
    public PostV1CaptureDocumentsGetResponseExtractionSupplier build() {
      return new PostV1CaptureDocumentsGetResponseExtractionSupplier(name, code, vatCode, countryCode, iban, additionalProperties);
    }
