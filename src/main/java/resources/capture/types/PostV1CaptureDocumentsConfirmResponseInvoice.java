...
@JsonDeserialize(
    builder = PostV1CaptureDocumentsConfirmResponseInvoice.Builder.class
)
public final class PostV1CaptureDocumentsConfirmResponseInvoice {
  private final String id;

  private final String partnerId;

  private final PostV1CaptureDocumentsConfirmResponseInvoiceType type;

  private final PostV1CaptureDocumentsConfirmResponseInvoiceStatus status;

  private final PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus paymentStatus;
  ...
  private final List<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem> lines;

  private final Map<String, Object> additionalProperties;

  private PostV1CaptureDocumentsConfirmResponseInvoice(String id, String partnerId,
      PostV1CaptureDocumentsConfirmResponseInvoiceType type,
      PostV1CaptureDocumentsConfirmResponseInvoiceStatus status,
      PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus paymentStatus,
      String documentNumber, String documentDate, Optional<String> dueDate,
      Optional<String> registrationDate, String currency, String netTotal, String vatTotal,
      ...
      List<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem> lines,
  ...
  @JsonProperty("type")
  public PostV1CaptureDocumentsConfirmResponseInvoiceType getType() {
    return type;
  }

  @JsonProperty("status")
  public PostV1CaptureDocumentsConfirmResponseInvoiceStatus getStatus() {
    return status;
  }

  @JsonProperty("paymentStatus")
  public PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus getPaymentStatus() {
  ...
  @JsonProperty("lines")
  public List<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem> getLines() {
    return lines;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CaptureDocumentsConfirmResponseInvoice && equalTo((PostV1CaptureDocumentsConfirmResponseInvoice) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1CaptureDocumentsConfirmResponseInvoice other);
  }
  ...
  public interface TypeStage {
    StatusStage type(@NotNull PostV1CaptureDocumentsConfirmResponseInvoiceType type);
  }

  public interface StatusStage {
    PaymentStatusStage status(@NotNull PostV1CaptureDocumentsConfirmResponseInvoiceStatus status);
  }

  public interface PaymentStatusStage {
    DocumentNumberStage paymentStatus(
        @NotNull PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus paymentStatus);
  }
  ...
  public interface _FinalStage {
    PostV1CaptureDocumentsConfirmResponseInvoice build();
    ...
    _FinalStage lines(List<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem> lines);

    _FinalStage addLines(PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem lines);

    _FinalStage addAllLines(List<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem> lines);
  }
  ...
  public static final class Builder implements IdStage, PartnerIdStage, TypeStage, StatusStage, PaymentStatusStage, DocumentNumberStage, DocumentDateStage, CurrencyStage, NetTotalStage, VatTotalStage, GrossTotalStage, PaidAmountStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1CaptureDocumentsConfirmResponseInvoiceType type;

    private PostV1CaptureDocumentsConfirmResponseInvoiceStatus status;

    private PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus paymentStatus;
    ...
    private List<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem> lines = new ArrayList<>();
    ...
    @java.lang.Override
    public Builder from(PostV1CaptureDocumentsConfirmResponseInvoice other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public StatusStage type(@NotNull PostV1CaptureDocumentsConfirmResponseInvoiceType type) {
    ...
    public PaymentStatusStage status(
        @NotNull PostV1CaptureDocumentsConfirmResponseInvoiceStatus status) {
    ...
    @java.lang.Override
    public _FinalStage addLines(PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem lines) {
    ...
    public _FinalStage lines(List<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem> lines) {
      this.lines.clear();
      if (lines != null) {
        this.lines.addAll(lines);
      }
    ...
    @java.lang.Override
    public PostV1CaptureDocumentsConfirmResponseInvoice build() {
      return new PostV1CaptureDocumentsConfirmResponseInvoice(id, partnerId, type, status, paymentStatus, documentNumber, documentDate, dueDate, registrationDate, currency, netTotal, vatTotal, grossTotal, paidAmount, journalTransactionId, creditedInvoiceId, purchaseOrderId, notes, createdAt, updatedAt, lines, additionalProperties);
    }
