...
@JsonDeserialize(
    builder = PostV1HrEmployeesAnonymizeResponseAddress.Builder.class
)
public final class PostV1HrEmployeesAnonymizeResponseAddress {
  ...
  private PostV1HrEmployeesAnonymizeResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesAnonymizeResponseAddress && equalTo((PostV1HrEmployeesAnonymizeResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1HrEmployeesAnonymizeResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1HrEmployeesAnonymizeResponseAddress other) {
    ...
    public PostV1HrEmployeesAnonymizeResponseAddress build() {
      return new PostV1HrEmployeesAnonymizeResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
