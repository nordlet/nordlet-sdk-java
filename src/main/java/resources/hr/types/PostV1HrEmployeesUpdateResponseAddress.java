...
@JsonDeserialize(
    builder = PostV1HrEmployeesUpdateResponseAddress.Builder.class
)
public final class PostV1HrEmployeesUpdateResponseAddress {
  ...
  private PostV1HrEmployeesUpdateResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesUpdateResponseAddress && equalTo((PostV1HrEmployeesUpdateResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1HrEmployeesUpdateResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1HrEmployeesUpdateResponseAddress other) {
    ...
    public PostV1HrEmployeesUpdateResponseAddress build() {
      return new PostV1HrEmployeesUpdateResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
