...
@JsonDeserialize(
    builder = PostV1HrEmployeesAnonymizeResponse.Builder.class
)
public final class PostV1HrEmployeesAnonymizeResponse {
  ...
  private final Optional<PostV1HrEmployeesAnonymizeResponseAddress> address;
  ...
  private final PostV1HrEmployeesAnonymizeResponseStatus status;
  ...
  private PostV1HrEmployeesAnonymizeResponse(String id, Optional<String> code, String firstName,
      String lastName, Optional<String> personalCode, Optional<String> birthDate,
      Optional<String> email, Optional<String> phone,
      Optional<PostV1HrEmployeesAnonymizeResponseAddress> address, Optional<String> iban,
  ...
  @JsonIgnore
  public Optional<PostV1HrEmployeesAnonymizeResponseAddress> getAddress() {
    if (address == null) {
      return Optional.empty();
    }
    return address;
  ...
  @JsonProperty("status")
  public PostV1HrEmployeesAnonymizeResponseStatus getStatus() {
    return status;
  }
  ...
  private Optional<PostV1HrEmployeesAnonymizeResponseAddress> _getAddress() {
    return address;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesAnonymizeResponse && equalTo((PostV1HrEmployeesAnonymizeResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1HrEmployeesAnonymizeResponse other);
  }
  ...
  public interface StatusStage {
    CreatedAtStage status(@NotNull PostV1HrEmployeesAnonymizeResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1HrEmployeesAnonymizeResponse build();
    ...
    _FinalStage address(Optional<PostV1HrEmployeesAnonymizeResponseAddress> address);

    _FinalStage address(PostV1HrEmployeesAnonymizeResponseAddress address);

    _FinalStage address(Nullable<PostV1HrEmployeesAnonymizeResponseAddress> address);
  ...
  public static final class Builder implements IdStage, FirstNameStage, LastNameStage, ApplyNpdStage, PensionAccumulationStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private Optional<PostV1HrEmployeesAnonymizeResponseAddress> address = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1HrEmployeesAnonymizeResponse other) {
      id(other.getId());
      code(other.getCode());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CreatedAtStage status(@NotNull PostV1HrEmployeesAnonymizeResponseStatus status) {
    ...
    @java.lang.Override
    public _FinalStage address(Nullable<PostV1HrEmployeesAnonymizeResponseAddress> address) {
      if (address.isNull()) {
        this.address = null;
      }
    ...
    @java.lang.Override
    public _FinalStage address(PostV1HrEmployeesAnonymizeResponseAddress address) {
    ...
    public _FinalStage address(Optional<PostV1HrEmployeesAnonymizeResponseAddress> address) {
      this.address = address;
      return this;
    }
