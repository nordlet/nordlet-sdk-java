...
@JsonDeserialize(
    builder = PostV1HrEmployeesListResponseRowsItem.Builder.class
)
public final class PostV1HrEmployeesListResponseRowsItem {
  ...
  private final Optional<PostV1HrEmployeesListResponseRowsItemAddress> address;
  ...
  private final PostV1HrEmployeesListResponseRowsItemStatus status;
  ...
  private PostV1HrEmployeesListResponseRowsItem(String id, Optional<String> code, String firstName,
      String lastName, Optional<String> personalCode, Optional<String> birthDate,
      Optional<String> email, Optional<String> phone,
      Optional<PostV1HrEmployeesListResponseRowsItemAddress> address, Optional<String> iban,
  ...
  @JsonIgnore
  public Optional<PostV1HrEmployeesListResponseRowsItemAddress> getAddress() {
    if (address == null) {
      return Optional.empty();
    }
    return address;
  ...
  @JsonProperty("status")
  public PostV1HrEmployeesListResponseRowsItemStatus getStatus() {
    return status;
  }
  ...
  private Optional<PostV1HrEmployeesListResponseRowsItemAddress> _getAddress() {
    return address;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesListResponseRowsItem && equalTo((PostV1HrEmployeesListResponseRowsItem) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1HrEmployeesListResponseRowsItem other);
  }
  ...
  public interface StatusStage {
    CreatedAtStage status(@NotNull PostV1HrEmployeesListResponseRowsItemStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1HrEmployeesListResponseRowsItem build();
    ...
    _FinalStage address(Optional<PostV1HrEmployeesListResponseRowsItemAddress> address);

    _FinalStage address(PostV1HrEmployeesListResponseRowsItemAddress address);

    _FinalStage address(Nullable<PostV1HrEmployeesListResponseRowsItemAddress> address);
  ...
  public static final class Builder implements IdStage, FirstNameStage, LastNameStage, ApplyNpdStage, PensionAccumulationStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private Optional<PostV1HrEmployeesListResponseRowsItemAddress> address = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1HrEmployeesListResponseRowsItem other) {
      id(other.getId());
      code(other.getCode());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CreatedAtStage status(@NotNull PostV1HrEmployeesListResponseRowsItemStatus status) {
    ...
    @java.lang.Override
    public _FinalStage address(Nullable<PostV1HrEmployeesListResponseRowsItemAddress> address) {
      if (address.isNull()) {
        this.address = null;
      }
    ...
    @java.lang.Override
    public _FinalStage address(PostV1HrEmployeesListResponseRowsItemAddress address) {
    ...
    public _FinalStage address(Optional<PostV1HrEmployeesListResponseRowsItemAddress> address) {
      this.address = address;
      return this;
    }
