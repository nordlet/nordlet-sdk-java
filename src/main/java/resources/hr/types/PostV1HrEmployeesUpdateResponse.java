...
@JsonDeserialize(
    builder = PostV1HrEmployeesUpdateResponse.Builder.class
)
public final class PostV1HrEmployeesUpdateResponse {
  ...
  private final Optional<PostV1HrEmployeesUpdateResponseAddress> address;
  ...
  private final Optional<List<PostV1HrEmployeesUpdateResponseAttributesItem>> attributes;

  private final String createdAt;

  private final Map<String, Object> additionalProperties;

  private PostV1HrEmployeesUpdateResponse(String id, Optional<String> code, String firstName,
  ...
  @JsonIgnore
  public Optional<PostV1HrEmployeesUpdateResponseAddress> getAddress() {
    if (address == null) {
      return Optional.empty();
    }
    return address;
  ...
  @JsonProperty("status")
  public PostV1HrEmployeesUpdateResponseStatus getStatus() {
    return status;
  }
  ...
  @JsonIgnore
  public Optional<List<PostV1HrEmployeesUpdateResponseAttributesItem>> getAttributes() {
    if (attributes == null) {
      return Optional.empty();
    }
    return attributes;
  ...
  private Optional<PostV1HrEmployeesUpdateResponseAddress> _getAddress() {
    return address;
  }
  ...
  private Optional<List<PostV1HrEmployeesUpdateResponseAttributesItem>> _getAttributes() {
    return attributes;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesUpdateResponse && equalTo((PostV1HrEmployeesUpdateResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1HrEmployeesUpdateResponse other);
  }
  ...
  public interface StatusStage {
    CreatedAtStage status(@NotNull PostV1HrEmployeesUpdateResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1HrEmployeesUpdateResponse build();
    ...
    _FinalStage address(Optional<PostV1HrEmployeesUpdateResponseAddress> address);

    _FinalStage address(PostV1HrEmployeesUpdateResponseAddress address);

    _FinalStage address(Nullable<PostV1HrEmployeesUpdateResponseAddress> address);
    ...
    _FinalStage attributes(
        Optional<List<PostV1HrEmployeesUpdateResponseAttributesItem>> attributes);

    _FinalStage attributes(List<PostV1HrEmployeesUpdateResponseAttributesItem> attributes);

    _FinalStage attributes(
        Nullable<List<PostV1HrEmployeesUpdateResponseAttributesItem>> attributes);
  }
  ...
  public static final class Builder implements IdStage, FirstNameStage, LastNameStage, ApplyNpdStage, PensionAccumulationStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1HrEmployeesUpdateResponseStatus status;

    private String createdAt;

    private Optional<List<PostV1HrEmployeesUpdateResponseAttributesItem>> attributes = Optional.empty();
    ...
    private Optional<PostV1HrEmployeesUpdateResponseAddress> address = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1HrEmployeesUpdateResponse other) {
      id(other.getId());
      code(other.getCode());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CreatedAtStage status(@NotNull PostV1HrEmployeesUpdateResponseStatus status) {
    ...
    @java.lang.Override
    public _FinalStage attributes(List<PostV1HrEmployeesUpdateResponseAttributesItem> attributes) {
    ...
    @java.lang.Override
    public _FinalStage address(Nullable<PostV1HrEmployeesUpdateResponseAddress> address) {
      if (address.isNull()) {
        this.address = null;
      }
    ...
    @java.lang.Override
    public _FinalStage address(PostV1HrEmployeesUpdateResponseAddress address) {
    ...
    public _FinalStage address(Optional<PostV1HrEmployeesUpdateResponseAddress> address) {
      this.address = address;
      return this;
    }
