...
@JsonDeserialize(
    builder = PostV1HrEmployeesCreateRequestAddress.Builder.class
)
public final class PostV1HrEmployeesCreateRequestAddress {
  ...
  private PostV1HrEmployeesCreateRequestAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesCreateRequestAddress && equalTo((PostV1HrEmployeesCreateRequestAddress) other);
  }
  ...
  private boolean equalTo(PostV1HrEmployeesCreateRequestAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1HrEmployeesCreateRequestAddress other) {
    ...
    public PostV1HrEmployeesCreateRequestAddress build() {
      return new PostV1HrEmployeesCreateRequestAddress(street, city, postalCode, countryCode, additionalProperties);
    }
