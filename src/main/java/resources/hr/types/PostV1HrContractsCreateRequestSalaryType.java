...
public final class PostV1HrContractsCreateRequestSalaryType {
  ...
  PostV1HrContractsCreateRequestSalaryType(Value value, String string) {
    this.value = value;
    this.string = string;
  }
  ...
  public boolean equals(Object other) {
    return (this == other) 
      || (other instanceof PostV1HrContractsCreateRequestSalaryType && this.string.equals(((PostV1HrContractsCreateRequestSalaryType) other).string));
  }
  ...
  public static PostV1HrContractsCreateRequestSalaryType valueOf(String value) {
    switch (value) {
      ...
      case "monthly":
        return MONTHLY;
      default:
        return new PostV1HrContractsCreateRequestSalaryType(Value.UNKNOWN, value);
    }
  }
