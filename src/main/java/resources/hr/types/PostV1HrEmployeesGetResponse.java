...
public final class PostV1HrEmployeesGetResponse {
  ...
  private final Optional<List<PostV1HrEmployeesGetResponseAttributesItem>> attributes;
  ...
  private PostV1HrEmployeesGetResponse(String id, Optional<String> code, String firstName,
      ...
      PostV1HrEmployeesGetResponseStatus status, Optional<String> notes,
      Optional<List<PostV1HrEmployeesGetResponseAttributesItem>> attributes, String createdAt,
  ...
  @JsonIgnore
  public Optional<List<PostV1HrEmployeesGetResponseAttributesItem>> getAttributes() {
    if (attributes == null) {
      return Optional.empty();
    }
    return attributes;
  ...
  private Optional<List<PostV1HrEmployeesGetResponseAttributesItem>> _getAttributes() {
    return attributes;
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage attributes(Optional<List<PostV1HrEmployeesGetResponseAttributesItem>> attributes);

    _FinalStage attributes(List<PostV1HrEmployeesGetResponseAttributesItem> attributes);

    _FinalStage attributes(Nullable<List<PostV1HrEmployeesGetResponseAttributesItem>> attributes);
  }
  ...
  public static final class Builder implements IdStage, FirstNameStage, LastNameStage, ApplyNpdStage, PensionAccumulationStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private Optional<List<PostV1HrEmployeesGetResponseAttributesItem>> attributes = Optional.empty();
    ...
    public _FinalStage attributes(
        Nullable<List<PostV1HrEmployeesGetResponseAttributesItem>> attributes) {
    ...
    @java.lang.Override
    public _FinalStage attributes(List<PostV1HrEmployeesGetResponseAttributesItem> attributes) {
    ...
    public _FinalStage attributes(
        Optional<List<PostV1HrEmployeesGetResponseAttributesItem>> attributes) {
      this.attributes = attributes;
      return this;
    }
    ...
    public PostV1HrEmployeesGetResponse build() {
      return new PostV1HrEmployeesGetResponse(id, code, firstName, lastName, personalCode, birthDate, email, phone, address, iban, socialInsuranceNo, socialInsuranceStart, hireDate, terminationDate, applyNpd, npdOverride, pensionAccumulation, status, notes, attributes, createdAt, additionalProperties);
    }
