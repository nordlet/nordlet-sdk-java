...
@JsonDeserialize(
    builder = PostV1HrEmployeesCreateResponseAddress.Builder.class
)
public final class PostV1HrEmployeesCreateResponseAddress {
  ...
  private PostV1HrEmployeesCreateResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesCreateResponseAddress && equalTo((PostV1HrEmployeesCreateResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1HrEmployeesCreateResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1HrEmployeesCreateResponseAddress other) {
    ...
    public PostV1HrEmployeesCreateResponseAddress build() {
      return new PostV1HrEmployeesCreateResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
