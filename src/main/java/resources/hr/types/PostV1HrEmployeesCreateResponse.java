...
@JsonDeserialize(
    builder = PostV1HrEmployeesCreateResponse.Builder.class
)
public final class PostV1HrEmployeesCreateResponse {
  ...
  private final Optional<PostV1HrEmployeesCreateResponseAddress> address;
  ...
  private final PostV1HrEmployeesCreateResponseStatus status;

  private final Optional<String> notes;

  private final Optional<List<PostV1HrEmployeesCreateResponseAttributesItem>> attributes;

  private final String createdAt;

  private final Map<String, Object> additionalProperties;

  private PostV1HrEmployeesCreateResponse(String id, Optional<String> code, String firstName,
      String lastName, Optional<String> personalCode, Optional<String> birthDate,
      Optional<String> email, Optional<String> phone,
      Optional<PostV1HrEmployeesCreateResponseAddress> address, Optional<String> iban,
      ...
      PostV1HrEmployeesCreateResponseStatus status, Optional<String> notes,
      Optional<List<PostV1HrEmployeesCreateResponseAttributesItem>> attributes, String createdAt,
  ...
  @JsonIgnore
  public Optional<PostV1HrEmployeesCreateResponseAddress> getAddress() {
    if (address == null) {
      return Optional.empty();
    }
    return address;
  ...
  @JsonProperty("status")
  public PostV1HrEmployeesCreateResponseStatus getStatus() {
    return status;
  }
  ...
  @JsonIgnore
  public Optional<List<PostV1HrEmployeesCreateResponseAttributesItem>> getAttributes() {
    if (attributes == null) {
      return Optional.empty();
    }
    return attributes;
  ...
  private Optional<PostV1HrEmployeesCreateResponseAddress> _getAddress() {
    return address;
  }
  ...
  private Optional<List<PostV1HrEmployeesCreateResponseAttributesItem>> _getAttributes() {
    return attributes;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesCreateResponse && equalTo((PostV1HrEmployeesCreateResponse) other);
  }
  ...
  private boolean equalTo(PostV1HrEmployeesCreateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1HrEmployeesCreateResponse other);
  }
  ...
  public interface StatusStage {
    CreatedAtStage status(@NotNull PostV1HrEmployeesCreateResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1HrEmployeesCreateResponse build();
    ...
    _FinalStage address(Optional<PostV1HrEmployeesCreateResponseAddress> address);

    _FinalStage address(PostV1HrEmployeesCreateResponseAddress address);

    _FinalStage address(Nullable<PostV1HrEmployeesCreateResponseAddress> address);
    ...
    _FinalStage attributes(
        Optional<List<PostV1HrEmployeesCreateResponseAttributesItem>> attributes);

    _FinalStage attributes(List<PostV1HrEmployeesCreateResponseAttributesItem> attributes);

    _FinalStage attributes(
        Nullable<List<PostV1HrEmployeesCreateResponseAttributesItem>> attributes);
  }
  ...
  public static final class Builder implements IdStage, FirstNameStage, LastNameStage, ApplyNpdStage, PensionAccumulationStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1HrEmployeesCreateResponseStatus status;

    private String createdAt;

    private Optional<List<PostV1HrEmployeesCreateResponseAttributesItem>> attributes = Optional.empty();
    ...
    private Optional<PostV1HrEmployeesCreateResponseAddress> address = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1HrEmployeesCreateResponse other) {
      id(other.getId());
      code(other.getCode());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CreatedAtStage status(@NotNull PostV1HrEmployeesCreateResponseStatus status) {
    ...
    @java.lang.Override
    public _FinalStage attributes(List<PostV1HrEmployeesCreateResponseAttributesItem> attributes) {
    ...
    @java.lang.Override
    public _FinalStage address(Nullable<PostV1HrEmployeesCreateResponseAddress> address) {
      if (address.isNull()) {
        this.address = null;
      }
    ...
    @java.lang.Override
    public _FinalStage address(PostV1HrEmployeesCreateResponseAddress address) {
    ...
    public _FinalStage address(Optional<PostV1HrEmployeesCreateResponseAddress> address) {
      this.address = address;
      return this;
    }
    ...
    @java.lang.Override
    public PostV1HrEmployeesCreateResponse build() {
      return new PostV1HrEmployeesCreateResponse(id, code, firstName, lastName, personalCode, birthDate, email, phone, address, iban, socialInsuranceNo, socialInsuranceStart, hireDate, terminationDate, applyNpd, npdOverride, pensionAccumulation, status, notes, attributes, createdAt, additionalProperties);
    }
