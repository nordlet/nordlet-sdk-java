...
@JsonDeserialize(
    builder = PostV1HrEmployeesListResponseRowsItemAddress.Builder.class
)
public final class PostV1HrEmployeesListResponseRowsItemAddress {
  ...
  private PostV1HrEmployeesListResponseRowsItemAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesListResponseRowsItemAddress && equalTo((PostV1HrEmployeesListResponseRowsItemAddress) other);
  }
  ...
  private boolean equalTo(PostV1HrEmployeesListResponseRowsItemAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1HrEmployeesListResponseRowsItemAddress other) {
    ...
    public PostV1HrEmployeesListResponseRowsItemAddress build() {
      return new PostV1HrEmployeesListResponseRowsItemAddress(street, city, postalCode, countryCode, additionalProperties);
    }
