...
@JsonDeserialize(
    builder = PostV1HrEmployeesGetResponseAddress.Builder.class
)
public final class PostV1HrEmployeesGetResponseAddress {
  ...
  private PostV1HrEmployeesGetResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1HrEmployeesGetResponseAddress && equalTo((PostV1HrEmployeesGetResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1HrEmployeesGetResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1HrEmployeesGetResponseAddress other) {
    ...
    public PostV1HrEmployeesGetResponseAddress build() {
      return new PostV1HrEmployeesGetResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
