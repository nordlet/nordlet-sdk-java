...
@JsonDeserialize(
    builder = PostV1PurchasesOrdersUpdateRequestLinesItem.Builder.class
)
public final class PostV1PurchasesOrdersUpdateRequestLinesItem {
  ...
  private final Optional<PostV1PurchasesOrdersUpdateRequestLinesItemQuantity> quantity;
  ...
  private PostV1PurchasesOrdersUpdateRequestLinesItem(Optional<String> itemId,
      Optional<String> description, Optional<String> unit,
      Optional<PostV1PurchasesOrdersUpdateRequestLinesItemQuantity> quantity,
  ...
  public Optional<PostV1PurchasesOrdersUpdateRequestLinesItemQuantity> getQuantity() {
    return quantity;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PurchasesOrdersUpdateRequestLinesItem && equalTo((PostV1PurchasesOrdersUpdateRequestLinesItem) other);
  }
  ...
  private boolean equalTo(PostV1PurchasesOrdersUpdateRequestLinesItem other) {
  ...
  public static final class Builder {
    ...
    private Optional<PostV1PurchasesOrdersUpdateRequestLinesItemQuantity> quantity = Optional.empty();
    ...
    public Builder from(PostV1PurchasesOrdersUpdateRequestLinesItem other) {
    ...
    public Builder quantity(PostV1PurchasesOrdersUpdateRequestLinesItemQuantity quantity) {
    ...
    public PostV1PurchasesOrdersUpdateRequestLinesItem build() {
      return new PostV1PurchasesOrdersUpdateRequestLinesItem(itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, projectId, accountCode, additionalProperties);
    }
