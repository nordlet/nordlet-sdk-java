...
public final class PostV1PurchasesInvoicesUpdateResponse {
  ...
  public static final class Builder implements IdStage, PartnerIdStage, TypeStage, StatusStage, PaymentStatusStage, DocumentNumberStage, DocumentDateStage, CurrencyStage, NetTotalStage, VatTotalStage, GrossTotalStage, PaidAmountStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    public PostV1PurchasesInvoicesUpdateResponse build() {
      return new PostV1PurchasesInvoicesUpdateResponse(id, partnerId, type, status, paymentStatus, documentNumber, documentDate, dueDate, registrationDate, currency, netTotal, vatTotal, grossTotal, paidAmount, journalTransactionId, creditedInvoiceId, purchaseOrderId, notes, createdAt, updatedAt, lines, additionalProperties);
    }
