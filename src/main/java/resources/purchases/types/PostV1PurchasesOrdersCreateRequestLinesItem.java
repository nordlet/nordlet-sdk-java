...
@JsonDeserialize(
    builder = PostV1PurchasesOrdersCreateRequestLinesItem.Builder.class
)
public final class PostV1PurchasesOrdersCreateRequestLinesItem {
  ...
  private final Optional<PostV1PurchasesOrdersCreateRequestLinesItemQuantity> quantity;
  ...
  private PostV1PurchasesOrdersCreateRequestLinesItem(Optional<String> itemId,
      Optional<String> description, Optional<String> unit,
      Optional<PostV1PurchasesOrdersCreateRequestLinesItemQuantity> quantity,
  ...
  public Optional<PostV1PurchasesOrdersCreateRequestLinesItemQuantity> getQuantity() {
    return quantity;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PurchasesOrdersCreateRequestLinesItem && equalTo((PostV1PurchasesOrdersCreateRequestLinesItem) other);
  }
  ...
  private boolean equalTo(PostV1PurchasesOrdersCreateRequestLinesItem other) {
  ...
  public static final class Builder {
    ...
    private Optional<PostV1PurchasesOrdersCreateRequestLinesItemQuantity> quantity = Optional.empty();
    ...
    public Builder from(PostV1PurchasesOrdersCreateRequestLinesItem other) {
    ...
    public Builder quantity(PostV1PurchasesOrdersCreateRequestLinesItemQuantity quantity) {
    ...
    public PostV1PurchasesOrdersCreateRequestLinesItem build() {
      return new PostV1PurchasesOrdersCreateRequestLinesItem(itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, projectId, accountCode, additionalProperties);
    }
