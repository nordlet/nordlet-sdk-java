...
public final class PostV1PurchasesInvoicesGetResponse {
  ...
  public static final class Builder implements IdStage, PartnerIdStage, TypeStage, StatusStage, PaymentStatusStage, DocumentNumberStage, DocumentDateStage, CurrencyStage, NetTotalStage, VatTotalStage, GrossTotalStage, PaidAmountStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    public PostV1PurchasesInvoicesGetResponse build() {
      return new PostV1PurchasesInvoicesGetResponse(id, partnerId, type, status, paymentStatus, documentNumber, documentDate, dueDate, registrationDate, currency, netTotal, vatTotal, grossTotal, paidAmount, journalTransactionId, creditedInvoiceId, notes, createdAt, updatedAt, lines, additionalProperties);
    }
