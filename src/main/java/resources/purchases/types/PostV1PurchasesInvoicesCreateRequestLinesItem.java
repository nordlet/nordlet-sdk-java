...
public final class PostV1PurchasesInvoicesCreateRequestLinesItem {
  ...
  public static final class Builder {
    ...
    public PostV1PurchasesInvoicesCreateRequestLinesItem build() {
      return new PostV1PurchasesInvoicesCreateRequestLinesItem(itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, projectId, accountCode, additionalProperties);
    }
