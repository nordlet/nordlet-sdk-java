...
@JsonDeserialize(
    builder = PostV1CashOrdersListResponseRowsItem.Builder.class
)
public final class PostV1CashOrdersListResponseRowsItem {
  private final String id;

  private final PostV1CashOrdersListResponseRowsItemType type;
  ...
  private PostV1CashOrdersListResponseRowsItem(String id,
      PostV1CashOrdersListResponseRowsItemType type, String series, long number, String fullNumber,
      String date, Optional<String> partnerId, Optional<String> employeeId, String amount,
      String currency, String purpose, String cashAccountCode, String counterAccountCode,
  ...
  @JsonProperty("type")
  public PostV1CashOrdersListResponseRowsItemType getType() {
    return type;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CashOrdersListResponseRowsItem && equalTo((PostV1CashOrdersListResponseRowsItem) other);
  }
  ...
  private boolean equalTo(PostV1CashOrdersListResponseRowsItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1CashOrdersListResponseRowsItem other);
  }

  public interface TypeStage {
    SeriesStage type(@NotNull PostV1CashOrdersListResponseRowsItemType type);
  }
  ...
  public interface _FinalStage {
    PostV1CashOrdersListResponseRowsItem build();
  ...
  public static final class Builder implements IdStage, TypeStage, SeriesStage, NumberStage, FullNumberStage, DateStage, AmountStage, CurrencyStage, PurposeStage, CashAccountCodeStage, CounterAccountCodeStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1CashOrdersListResponseRowsItemType type;
    ...
    @java.lang.Override
    public Builder from(PostV1CashOrdersListResponseRowsItem other) {
      id(other.getId());
      type(other.getType());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public SeriesStage type(@NotNull PostV1CashOrdersListResponseRowsItemType type) {
    ...
    @java.lang.Override
    public PostV1CashOrdersListResponseRowsItem build() {
      return new PostV1CashOrdersListResponseRowsItem(id, type, series, number, fullNumber, date, partnerId, employeeId, amount, currency, purpose, cashAccountCode, counterAccountCode, journalTransactionId, notes, createdAt, additionalProperties);
    }
