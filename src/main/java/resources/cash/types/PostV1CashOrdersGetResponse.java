...
@JsonDeserialize(
    builder = PostV1CashOrdersGetResponse.Builder.class
)
public final class PostV1CashOrdersGetResponse {
  private final String id;

  private final PostV1CashOrdersGetResponseType type;
  ...
  private PostV1CashOrdersGetResponse(String id, PostV1CashOrdersGetResponseType type,
  ...
  @JsonProperty("type")
  public PostV1CashOrdersGetResponseType getType() {
    return type;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CashOrdersGetResponse && equalTo((PostV1CashOrdersGetResponse) other);
  }
  ...
  private boolean equalTo(PostV1CashOrdersGetResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1CashOrdersGetResponse other);
  }

  public interface TypeStage {
    SeriesStage type(@NotNull PostV1CashOrdersGetResponseType type);
  }
  ...
  public interface _FinalStage {
    PostV1CashOrdersGetResponse build();
  ...
  public static final class Builder implements IdStage, TypeStage, SeriesStage, NumberStage, FullNumberStage, DateStage, AmountStage, CurrencyStage, PurposeStage, CashAccountCodeStage, CounterAccountCodeStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1CashOrdersGetResponseType type;
    ...
    @java.lang.Override
    public Builder from(PostV1CashOrdersGetResponse other) {
      id(other.getId());
      type(other.getType());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public SeriesStage type(@NotNull PostV1CashOrdersGetResponseType type) {
    ...
    @java.lang.Override
    public PostV1CashOrdersGetResponse build() {
      return new PostV1CashOrdersGetResponse(id, type, series, number, fullNumber, date, partnerId, employeeId, amount, currency, purpose, cashAccountCode, counterAccountCode, journalTransactionId, notes, createdAt, additionalProperties);
    }
