...
public class AsyncDeclarationsClient {
   ...
   */
  public CompletableFuture<PostV1DeclarationsPlJpkV7MGenerateResponse> postV1DeclarationsPlJpkV7MGenerate(
      PostV1DeclarationsPlJpkV7MGenerateRequest request) {
    return this.rawClient.postV1DeclarationsPlJpkV7MGenerate(request).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<PostV1DeclarationsPlJpkV7MGenerateResponse> postV1DeclarationsPlJpkV7MGenerate(
    ...
    return this.rawClient.postV1DeclarationsPlJpkV7MGenerate(request, requestOptions).thenApply(response -> response.body());
  }
