...
@JsonDeserialize(
    builder = PostV1PayrollRunsGetResponse.Builder.class
)
public final class PostV1PayrollRunsGetResponse {
  ...
  private final List<PostV1PayrollRunsGetResponseLinesItem> lines;
  ...
  @JsonProperty("lines")
  public List<PostV1PayrollRunsGetResponseLinesItem> getLines() {
    return lines;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PayrollRunsGetResponse && equalTo((PostV1PayrollRunsGetResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1PayrollRunsGetResponse other);
  }
  ...
  public interface StatusStage {
    GrossTotalStage status(@NotNull PostV1PayrollRunsGetResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1PayrollRunsGetResponse build();
    ...
    _FinalStage lines(List<PostV1PayrollRunsGetResponseLinesItem> lines);

    _FinalStage addLines(PostV1PayrollRunsGetResponseLinesItem lines);

    _FinalStage addAllLines(List<PostV1PayrollRunsGetResponseLinesItem> lines);
  }
  ...
  public static final class Builder implements IdStage, YearStage, MonthStage, StatusStage, GrossTotalStage, NpdTotalStage, GpmTotalStage, SodraEmployeeTotalStage, SodraEmployerTotalStage, NetTotalStage, CreatedAtStage, _FinalStage {
    ...
    private List<PostV1PayrollRunsGetResponseLinesItem> lines = new ArrayList<>();
    ...
    @java.lang.Override
    public Builder from(PostV1PayrollRunsGetResponse other) {
      id(other.getId());
      year(other.getYear());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public GrossTotalStage status(@NotNull PostV1PayrollRunsGetResponseStatus status) {
    ...
    @java.lang.Override
    public _FinalStage addAllLines(List<PostV1PayrollRunsGetResponseLinesItem> lines) {
      if (lines != null) {
    ...
    @java.lang.Override
    public _FinalStage addLines(PostV1PayrollRunsGetResponseLinesItem lines) {
    ...
    public _FinalStage lines(List<PostV1PayrollRunsGetResponseLinesItem> lines) {
      this.lines.clear();
      if (lines != null) {
        this.lines.addAll(lines);
      }
