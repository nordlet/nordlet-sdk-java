...
@JsonDeserialize(
    builder = PostV1PayrollRunsCreateResponse.Builder.class
)
public final class PostV1PayrollRunsCreateResponse {
  ...
  private final PostV1PayrollRunsCreateResponseStatus status;
  ...
  private final List<PostV1PayrollRunsCreateResponseLinesItem> lines;

  private final Map<String, Object> additionalProperties;

  private PostV1PayrollRunsCreateResponse(String id, long year, long month,
      PostV1PayrollRunsCreateResponseStatus status, String grossTotal, String npdTotal,
      ...
      Optional<String> approvedAt, List<PostV1PayrollRunsCreateResponseLinesItem> lines,
  ...
  @JsonProperty("status")
  public PostV1PayrollRunsCreateResponseStatus getStatus() {
    return status;
  }
  ...
  @JsonProperty("lines")
  public List<PostV1PayrollRunsCreateResponseLinesItem> getLines() {
    return lines;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PayrollRunsCreateResponse && equalTo((PostV1PayrollRunsCreateResponse) other);
  }
  ...
  private boolean equalTo(PostV1PayrollRunsCreateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1PayrollRunsCreateResponse other);
  }
  ...
  public interface StatusStage {
    GrossTotalStage status(@NotNull PostV1PayrollRunsCreateResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1PayrollRunsCreateResponse build();
    ...
    _FinalStage lines(List<PostV1PayrollRunsCreateResponseLinesItem> lines);

    _FinalStage addLines(PostV1PayrollRunsCreateResponseLinesItem lines);

    _FinalStage addAllLines(List<PostV1PayrollRunsCreateResponseLinesItem> lines);
  }
  ...
  public static final class Builder implements IdStage, YearStage, MonthStage, StatusStage, GrossTotalStage, NpdTotalStage, GpmTotalStage, SodraEmployeeTotalStage, SodraEmployerTotalStage, NetTotalStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1PayrollRunsCreateResponseStatus status;
    ...
    private List<PostV1PayrollRunsCreateResponseLinesItem> lines = new ArrayList<>();
    ...
    @java.lang.Override
    public Builder from(PostV1PayrollRunsCreateResponse other) {
      id(other.getId());
      year(other.getYear());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public GrossTotalStage status(@NotNull PostV1PayrollRunsCreateResponseStatus status) {
    ...
    @java.lang.Override
    public _FinalStage addAllLines(List<PostV1PayrollRunsCreateResponseLinesItem> lines) {
      if (lines != null) {
    ...
    @java.lang.Override
    public _FinalStage addLines(PostV1PayrollRunsCreateResponseLinesItem lines) {
    ...
    public _FinalStage lines(List<PostV1PayrollRunsCreateResponseLinesItem> lines) {
      this.lines.clear();
      if (lines != null) {
        this.lines.addAll(lines);
      }
    ...
    @java.lang.Override
    public PostV1PayrollRunsCreateResponse build() {
      return new PostV1PayrollRunsCreateResponse(id, year, month, status, grossTotal, npdTotal, gpmTotal, sodraEmployeeTotal, sodraEmployerTotal, netTotal, journalTransactionId, notes, createdAt, approvedAt, lines, additionalProperties);
    }
