...
public final class PostV1LedgerJournalTransactionsCreateResponse {
  ...
  private PostV1LedgerJournalTransactionsCreateResponse(String id, String date,
      ...
      Optional<String> partnerId, PostV1LedgerJournalTransactionsCreateResponseStatus status,
  ...
  public static final class Builder implements IdStage, DateStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    public PostV1LedgerJournalTransactionsCreateResponse build() {
      return new PostV1LedgerJournalTransactionsCreateResponse(id, date, description, documentType, documentId, partnerId, status, createdAt, postedAt, additionalProperties);
    }
