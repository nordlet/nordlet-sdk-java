...
@JsonDeserialize(
    builder = PostV1LedgerOwnersListResponseRowsItemAddress.Builder.class
)
public final class PostV1LedgerOwnersListResponseRowsItemAddress {
  ...
  private PostV1LedgerOwnersListResponseRowsItemAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LedgerOwnersListResponseRowsItemAddress && equalTo((PostV1LedgerOwnersListResponseRowsItemAddress) other);
  }
  ...
  private boolean equalTo(PostV1LedgerOwnersListResponseRowsItemAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1LedgerOwnersListResponseRowsItemAddress other) {
    ...
    public PostV1LedgerOwnersListResponseRowsItemAddress build() {
      return new PostV1LedgerOwnersListResponseRowsItemAddress(street, city, postalCode, countryCode, additionalProperties);
    }
