...
@JsonDeserialize(
    builder = PostV1LedgerOwnersUpdateResponseAddress.Builder.class
)
public final class PostV1LedgerOwnersUpdateResponseAddress {
  ...
  private PostV1LedgerOwnersUpdateResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LedgerOwnersUpdateResponseAddress && equalTo((PostV1LedgerOwnersUpdateResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1LedgerOwnersUpdateResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1LedgerOwnersUpdateResponseAddress other) {
    ...
    public PostV1LedgerOwnersUpdateResponseAddress build() {
      return new PostV1LedgerOwnersUpdateResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
