...
@JsonDeserialize(
    builder = PostV1LedgerJournalTransactionsGetResponse.Builder.class
)
public final class PostV1LedgerJournalTransactionsGetResponse {
  ...
  private final List<PostV1LedgerJournalTransactionsGetResponseEntriesItem> entries;
  ...
  @JsonProperty("status")
  public PostV1LedgerJournalTransactionsGetResponseStatus getStatus() {
    return status;
  }
  ...
  public List<PostV1LedgerJournalTransactionsGetResponseEntriesItem> getEntries() {
    return entries;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LedgerJournalTransactionsGetResponse && equalTo((PostV1LedgerJournalTransactionsGetResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1LedgerJournalTransactionsGetResponse other);
  }
  ...
  public interface StatusStage {
    CreatedAtStage status(@NotNull PostV1LedgerJournalTransactionsGetResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1LedgerJournalTransactionsGetResponse build();
    ...
    _FinalStage entries(List<PostV1LedgerJournalTransactionsGetResponseEntriesItem> entries);

    _FinalStage addEntries(PostV1LedgerJournalTransactionsGetResponseEntriesItem entries);

    _FinalStage addAllEntries(List<PostV1LedgerJournalTransactionsGetResponseEntriesItem> entries);
  }
  ...
  public static final class Builder implements IdStage, DateStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1LedgerJournalTransactionsGetResponseStatus status;

    private String createdAt;

    private List<PostV1LedgerJournalTransactionsGetResponseEntriesItem> entries = new ArrayList<>();
    ...
    @java.lang.Override
    public Builder from(PostV1LedgerJournalTransactionsGetResponse other) {
      id(other.getId());
      date(other.getDate());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CreatedAtStage status(@NotNull PostV1LedgerJournalTransactionsGetResponseStatus status) {
    ...
    @java.lang.Override
    public _FinalStage addEntries(PostV1LedgerJournalTransactionsGetResponseEntriesItem entries) {
