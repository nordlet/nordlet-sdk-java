...
@JsonDeserialize(
    builder = PostV1LedgerAccountsUpdateResponse.Builder.class
)
public final class PostV1LedgerAccountsUpdateResponse {
  ...
  @JsonProperty("type")
  public PostV1LedgerAccountsUpdateResponseType getType() {
    return type;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LedgerAccountsUpdateResponse && equalTo((PostV1LedgerAccountsUpdateResponse) other);
  }
  ...
  private boolean equalTo(PostV1LedgerAccountsUpdateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1LedgerAccountsUpdateResponse other);
  }
  ...
  public interface TypeStage {
    IsPostableStage type(@NotNull PostV1LedgerAccountsUpdateResponseType type);
  }
  ...
  public interface _FinalStage {
    PostV1LedgerAccountsUpdateResponse build();
  ...
  public static final class Builder implements IdStage, CodeStage, NameStage, TypeStage, IsPostableStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1LedgerAccountsUpdateResponseType type;
    ...
    @java.lang.Override
    public Builder from(PostV1LedgerAccountsUpdateResponse other) {
      id(other.getId());
      code(other.getCode());
      name(other.getName());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public IsPostableStage type(@NotNull PostV1LedgerAccountsUpdateResponseType type) {
    ...
    @java.lang.Override
    public PostV1LedgerAccountsUpdateResponse build() {
      return new PostV1LedgerAccountsUpdateResponse(id, code, name, translations, type, parentId, isPostable, createdAt, additionalProperties);
    }
