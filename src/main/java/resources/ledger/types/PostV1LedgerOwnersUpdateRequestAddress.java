...
@JsonDeserialize(
    builder = PostV1LedgerOwnersUpdateRequestAddress.Builder.class
)
public final class PostV1LedgerOwnersUpdateRequestAddress {
  ...
  private PostV1LedgerOwnersUpdateRequestAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LedgerOwnersUpdateRequestAddress && equalTo((PostV1LedgerOwnersUpdateRequestAddress) other);
  }
  ...
  private boolean equalTo(PostV1LedgerOwnersUpdateRequestAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1LedgerOwnersUpdateRequestAddress other) {
    ...
    public PostV1LedgerOwnersUpdateRequestAddress build() {
      return new PostV1LedgerOwnersUpdateRequestAddress(street, city, postalCode, countryCode, additionalProperties);
    }
