...
@JsonDeserialize(
    builder = PostV1LedgerOwnersCreateResponseAddress.Builder.class
)
public final class PostV1LedgerOwnersCreateResponseAddress {
  ...
  private PostV1LedgerOwnersCreateResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LedgerOwnersCreateResponseAddress && equalTo((PostV1LedgerOwnersCreateResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1LedgerOwnersCreateResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1LedgerOwnersCreateResponseAddress other) {
    ...
    public PostV1LedgerOwnersCreateResponseAddress build() {
      return new PostV1LedgerOwnersCreateResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
