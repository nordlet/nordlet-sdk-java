...
@JsonDeserialize(
    builder = PostV1LedgerOwnersCreateRequestAddress.Builder.class
)
public final class PostV1LedgerOwnersCreateRequestAddress {
  ...
  private PostV1LedgerOwnersCreateRequestAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LedgerOwnersCreateRequestAddress && equalTo((PostV1LedgerOwnersCreateRequestAddress) other);
  }
  ...
  private boolean equalTo(PostV1LedgerOwnersCreateRequestAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1LedgerOwnersCreateRequestAddress other) {
    ...
    public PostV1LedgerOwnersCreateRequestAddress build() {
      return new PostV1LedgerOwnersCreateRequestAddress(street, city, postalCode, countryCode, additionalProperties);
    }
