...
public final class PostV1AssetsAssetsListResponseRowsItem {
  ...
  @JsonIgnore
  public Optional<List<PostV1AssetsAssetsListResponseRowsItemDocumentsItem>> getDocuments() {
    if (documents == null) {
      return Optional.empty();
    }
    return documents;
  ...
  private Optional<List<PostV1AssetsAssetsListResponseRowsItemDocumentsItem>> _getDocuments() {
    return documents;
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage documents(List<PostV1AssetsAssetsListResponseRowsItemDocumentsItem> documents);
  ...
  public static final class Builder implements IdStage, GroupIdStage, CodeStage, NameStage, AcquisitionDateStage, DepreciationStartDateStage, AcquisitionCostStage, SalvageValueStage, UsefulLifeMonthsStage, TotalCostStage, AccumulatedDepreciationStage, NetBookValueStage, DepreciatedMonthsStage, TotalLifeMonthsStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    @java.lang.Override
    public _FinalStage documents(
        List<PostV1AssetsAssetsListResponseRowsItemDocumentsItem> documents) {
