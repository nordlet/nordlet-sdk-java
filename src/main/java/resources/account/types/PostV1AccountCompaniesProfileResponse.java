...
@JsonDeserialize(
    builder = PostV1AccountCompaniesProfileResponse.Builder.class
)
public final class PostV1AccountCompaniesProfileResponse {
  ...
  private final PostV1AccountCompaniesProfileResponseStatus status;

  private final Optional<PostV1AccountCompaniesProfileResponseAddress> address;
  ...
  @JsonProperty("status")
  public PostV1AccountCompaniesProfileResponseStatus getStatus() {
    return status;
  }

  @JsonIgnore
  public Optional<PostV1AccountCompaniesProfileResponseAddress> getAddress() {
    if (address == null) {
      return Optional.empty();
    }
    return address;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1AccountCompaniesProfileResponse && equalTo((PostV1AccountCompaniesProfileResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1AccountCompaniesProfileResponse other);
  }
  ...
  public interface _FinalStage {
    PostV1AccountCompaniesProfileResponse build();
    ...
    _FinalStage address(PostV1AccountCompaniesProfileResponseAddress address);

    _FinalStage address(Nullable<PostV1AccountCompaniesProfileResponseAddress> address);
  ...
  public static final class Builder implements IdStage, NameStage, IsVatPayerStage, IsSandboxStage, CountryCodeStage, BaseCurrencyStage, DefaultInvoiceCurrencyStage, StatusStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PostV1AccountCompaniesProfileResponse other) {
      id(other.getId());
      name(other.getName());
      code(other.getCode());
    ...
    @java.lang.Override
    public _FinalStage address(Nullable<PostV1AccountCompaniesProfileResponseAddress> address) {
      if (address.isNull()) {
        this.address = null;
      }
    ...
    @java.lang.Override
    public _FinalStage address(PostV1AccountCompaniesProfileResponseAddress address) {
    ...
    public _FinalStage address(Optional<PostV1AccountCompaniesProfileResponseAddress> address) {
      this.address = address;
      return this;
    }
