...
@JsonDeserialize(
    builder = PostV1AccountCompaniesUpdateResponseAddress.Builder.class
)
public final class PostV1AccountCompaniesUpdateResponseAddress {
  ...
  private PostV1AccountCompaniesUpdateResponseAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1AccountCompaniesUpdateResponseAddress && equalTo((PostV1AccountCompaniesUpdateResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1AccountCompaniesUpdateResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1AccountCompaniesUpdateResponseAddress other) {
    ...
    public PostV1AccountCompaniesUpdateResponseAddress build() {
      return new PostV1AccountCompaniesUpdateResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
