...
@JsonDeserialize(
    builder = PostV1AccountCompaniesProfileResponseAddress.Builder.class
)
public final class PostV1AccountCompaniesProfileResponseAddress {
  ...
  private PostV1AccountCompaniesProfileResponseAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1AccountCompaniesProfileResponseAddress && equalTo((PostV1AccountCompaniesProfileResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1AccountCompaniesProfileResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1AccountCompaniesProfileResponseAddress other) {
    ...
    public PostV1AccountCompaniesProfileResponseAddress build() {
      return new PostV1AccountCompaniesProfileResponseAddress(street, city, postalCode, countryCode, additionalProperties);
    }
