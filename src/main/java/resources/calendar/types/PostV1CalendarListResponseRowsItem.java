...
@JsonDeserialize(
    builder = PostV1CalendarListResponseRowsItem.Builder.class
)
public final class PostV1CalendarListResponseRowsItem {
  private final String key;

  private final Optional<String> id;

  private final PostV1CalendarListResponseRowsItemKind kind;
  ...
  private PostV1CalendarListResponseRowsItem(String key, Optional<String> id,
      PostV1CalendarListResponseRowsItemKind kind, Optional<String> ruleKey,
      Optional<String> period, String title, String dueDate, Optional<String> notes, boolean done,
      Optional<String> href, Map<String, Object> additionalProperties) {
    this.key = key;
    this.id = id;
    this.kind = kind;
  ...
  @JsonProperty("kind")
  public PostV1CalendarListResponseRowsItemKind getKind() {
    return kind;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CalendarListResponseRowsItem && equalTo((PostV1CalendarListResponseRowsItem) other);
  }
  ...
  private boolean equalTo(PostV1CalendarListResponseRowsItem other) {
  ...
  public interface KeyStage {
    ...
    Builder from(PostV1CalendarListResponseRowsItem other);
  }

  public interface KindStage {
    TitleStage kind(@NotNull PostV1CalendarListResponseRowsItemKind kind);
  }
  ...
  public interface _FinalStage {
    PostV1CalendarListResponseRowsItem build();
  ...
  public static final class Builder implements KeyStage, KindStage, TitleStage, DueDateStage, DoneStage, _FinalStage {
    ...
    private PostV1CalendarListResponseRowsItemKind kind;
    ...
    @java.lang.Override
    public Builder from(PostV1CalendarListResponseRowsItem other) {
      key(other.getKey());
      id(other.getId());
      kind(other.getKind());
    ...
    @java.lang.Override
    @JsonSetter("kind")
    public TitleStage kind(@NotNull PostV1CalendarListResponseRowsItemKind kind) {
    ...
    @java.lang.Override
    public PostV1CalendarListResponseRowsItem build() {
      return new PostV1CalendarListResponseRowsItem(key, id, kind, ruleKey, period, title, dueDate, notes, done, href, additionalProperties);
    }
