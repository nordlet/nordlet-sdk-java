...
@JsonDeserialize(
    builder = PostV1CalendarCreateResponse.Builder.class
)
public final class PostV1CalendarCreateResponse {
  private final String key;

  private final Optional<String> id;

  private final PostV1CalendarCreateResponseKind kind;
  ...
  @JsonProperty("kind")
  public PostV1CalendarCreateResponseKind getKind() {
    return kind;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CalendarCreateResponse && equalTo((PostV1CalendarCreateResponse) other);
  }
  ...
  public interface KeyStage {
    ...
    Builder from(PostV1CalendarCreateResponse other);
  }

  public interface KindStage {
    TitleStage kind(@NotNull PostV1CalendarCreateResponseKind kind);
  }
  ...
  public interface _FinalStage {
    PostV1CalendarCreateResponse build();
  ...
  public static final class Builder implements KeyStage, KindStage, TitleStage, DueDateStage, DoneStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PostV1CalendarCreateResponse other) {
      key(other.getKey());
      id(other.getId());
      kind(other.getKind());
    ...
    @java.lang.Override
    @JsonSetter("kind")
    public TitleStage kind(@NotNull PostV1CalendarCreateResponseKind kind) {
