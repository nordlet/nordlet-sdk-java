...
@JsonDeserialize(
    builder = PostV1CalendarGetResponse.Builder.class
)
public final class PostV1CalendarGetResponse {
  private final String key;

  private final Optional<String> id;

  private final PostV1CalendarGetResponseKind kind;
  ...
  private PostV1CalendarGetResponse(String key, Optional<String> id,
      PostV1CalendarGetResponseKind kind, Optional<String> ruleKey, Optional<String> period,
  ...
  @JsonProperty("kind")
  public PostV1CalendarGetResponseKind getKind() {
    return kind;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CalendarGetResponse && equalTo((PostV1CalendarGetResponse) other);
  }
  ...
  private boolean equalTo(PostV1CalendarGetResponse other) {
  ...
  public interface KeyStage {
    ...
    Builder from(PostV1CalendarGetResponse other);
  }

  public interface KindStage {
    TitleStage kind(@NotNull PostV1CalendarGetResponseKind kind);
  }
  ...
  public interface _FinalStage {
    PostV1CalendarGetResponse build();
  ...
  public static final class Builder implements KeyStage, KindStage, TitleStage, DueDateStage, DoneStage, _FinalStage {
    ...
    private PostV1CalendarGetResponseKind kind;
    ...
    @java.lang.Override
    public Builder from(PostV1CalendarGetResponse other) {
      key(other.getKey());
      id(other.getId());
      kind(other.getKind());
    ...
    @java.lang.Override
    @JsonSetter("kind")
    public TitleStage kind(@NotNull PostV1CalendarGetResponseKind kind) {
    ...
    @java.lang.Override
    public PostV1CalendarGetResponse build() {
      return new PostV1CalendarGetResponse(key, id, kind, ruleKey, period, title, dueDate, notes, done, href, additionalProperties);
    }
