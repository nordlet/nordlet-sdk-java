...
public final class PostV1AgreementsAgreementsCreateResponse {
  ...
  private PostV1AgreementsAgreementsCreateResponse(String id, Optional<String> typeId,
      ...
      PostV1AgreementsAgreementsCreateResponseStatus status, Optional<String> notes,
      String createdAt, List<PostV1AgreementsAgreementsCreateResponseItemsItem> items,
  ...
  public static final class Builder implements IdStage, PartnerIdStage, NumberStage, StartDateStage, AutoRenewStage, CurrencyStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    public PostV1AgreementsAgreementsCreateResponse build() {
      return new PostV1AgreementsAgreementsCreateResponse(id, typeId, partnerId, number, name, startDate, endDate, autoRenew, value, currency, status, notes, createdAt, items, additionalProperties);
    }
