...
public final class PostV1AgreementsAgreementsUpdateResponse {
  ...
  private final PostV1AgreementsAgreementsUpdateResponseKind kind;
  ...
  private final Optional<PostV1AgreementsAgreementsUpdateResponseBillingPeriod> billingPeriod;
  ...
  private PostV1AgreementsAgreementsUpdateResponse(String id, Optional<String> typeId,
      PostV1AgreementsAgreementsUpdateResponseKind kind, Optional<String> partnerId,
      ...
      Optional<PostV1AgreementsAgreementsUpdateResponseBillingPeriod> billingPeriod,
      String currency, PostV1AgreementsAgreementsUpdateResponseStatus status,
      Optional<String> notes, Optional<String> documentRef, String createdAt,
      List<PostV1AgreementsAgreementsUpdateResponseItemsItem> items,
  ...
  @JsonProperty("kind")
  public PostV1AgreementsAgreementsUpdateResponseKind getKind() {
    return kind;
  }
  ...
  @JsonIgnore
  public Optional<PostV1AgreementsAgreementsUpdateResponseBillingPeriod> getBillingPeriod() {
  ...
  private Optional<PostV1AgreementsAgreementsUpdateResponseBillingPeriod> _getBillingPeriod() {
    return billingPeriod;
  }
  ...
  public interface KindStage {
    NumberStage kind(@NotNull PostV1AgreementsAgreementsUpdateResponseKind kind);
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage billingPeriod(PostV1AgreementsAgreementsUpdateResponseBillingPeriod billingPeriod);

    _FinalStage billingPeriod(
        Nullable<PostV1AgreementsAgreementsUpdateResponseBillingPeriod> billingPeriod);
  ...
  public static final class Builder implements IdStage, KindStage, NumberStage, StartDateStage, AutoRenewStage, CurrencyStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1AgreementsAgreementsUpdateResponseKind kind;
    ...
    private Optional<PostV1AgreementsAgreementsUpdateResponseBillingPeriod> billingPeriod = Optional.empty();
    ...
    @java.lang.Override
    @JsonSetter("kind")
    public NumberStage kind(@NotNull PostV1AgreementsAgreementsUpdateResponseKind kind) {
    ...
    @java.lang.Override
    public _FinalStage billingPeriod(
        PostV1AgreementsAgreementsUpdateResponseBillingPeriod billingPeriod) {
    ...
    public PostV1AgreementsAgreementsUpdateResponse build() {
      return new PostV1AgreementsAgreementsUpdateResponse(id, typeId, kind, partnerId, employeeId, bankAccountId, number, name, startDate, endDate, autoRenew, value, billingPeriod, currency, status, notes, documentRef, createdAt, items, additionalProperties);
    }
