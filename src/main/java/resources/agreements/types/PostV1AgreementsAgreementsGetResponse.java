...
@JsonDeserialize(
    builder = PostV1AgreementsAgreementsGetResponse.Builder.class
)
public final class PostV1AgreementsAgreementsGetResponse {
  private final String id;

  private final Optional<String> typeId;

  private final PostV1AgreementsAgreementsGetResponseKind kind;
  ...
  private final List<PostV1AgreementsAgreementsGetResponseItemsItem> items;

  private final Map<String, Object> additionalProperties;

  private PostV1AgreementsAgreementsGetResponse(String id, Optional<String> typeId,
      PostV1AgreementsAgreementsGetResponseKind kind, Optional<String> partnerId,
      ...
      PostV1AgreementsAgreementsGetResponseStatus status, Optional<String> notes,
      Optional<String> documentRef, String createdAt,
  ...
  @JsonProperty("kind")
  public PostV1AgreementsAgreementsGetResponseKind getKind() {
    return kind;
  }
  ...
  @JsonProperty("status")
  public PostV1AgreementsAgreementsGetResponseStatus getStatus() {
    return status;
  }
  ...
  @JsonProperty("items")
  public List<PostV1AgreementsAgreementsGetResponseItemsItem> getItems() {
    return items;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1AgreementsAgreementsGetResponse && equalTo((PostV1AgreementsAgreementsGetResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1AgreementsAgreementsGetResponse other);
  }

  public interface KindStage {
    NumberStage kind(@NotNull PostV1AgreementsAgreementsGetResponseKind kind);
  }
  ...
  public interface StatusStage {
    CreatedAtStage status(@NotNull PostV1AgreementsAgreementsGetResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1AgreementsAgreementsGetResponse build();
    ...
    _FinalStage items(List<PostV1AgreementsAgreementsGetResponseItemsItem> items);

    _FinalStage addItems(PostV1AgreementsAgreementsGetResponseItemsItem items);

    _FinalStage addAllItems(List<PostV1AgreementsAgreementsGetResponseItemsItem> items);
  }
  ...
  public static final class Builder implements IdStage, KindStage, NumberStage, StartDateStage, AutoRenewStage, CurrencyStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1AgreementsAgreementsGetResponseKind kind;
    ...
    private PostV1AgreementsAgreementsGetResponseStatus status;

    private String createdAt;

    private List<PostV1AgreementsAgreementsGetResponseItemsItem> items = new ArrayList<>();
    ...
    @java.lang.Override
    public Builder from(PostV1AgreementsAgreementsGetResponse other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("kind")
    public NumberStage kind(@NotNull PostV1AgreementsAgreementsGetResponseKind kind) {
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CreatedAtStage status(@NotNull PostV1AgreementsAgreementsGetResponseStatus status) {
    ...
    @java.lang.Override
    public _FinalStage addAllItems(List<PostV1AgreementsAgreementsGetResponseItemsItem> items) {
      if (items != null) {
    ...
    @java.lang.Override
    public _FinalStage addItems(PostV1AgreementsAgreementsGetResponseItemsItem items) {
    ...
    public _FinalStage items(List<PostV1AgreementsAgreementsGetResponseItemsItem> items) {
      this.items.clear();
      if (items != null) {
        this.items.addAll(items);
      }
    ...
    public PostV1AgreementsAgreementsGetResponse build() {
      return new PostV1AgreementsAgreementsGetResponse(id, typeId, kind, partnerId, employeeId, bankAccountId, number, name, startDate, endDate, autoRenew, value, billingPeriod, currency, status, notes, documentRef, createdAt, items, additionalProperties);
    }
