...
@JsonDeserialize(
    builder = PostV1AgreementsAgreementsGetResponseItemsItem.Builder.class
)
public final class PostV1AgreementsAgreementsGetResponseItemsItem {
  ...
  private PostV1AgreementsAgreementsGetResponseItemsItem(String id, Optional<String> itemId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1AgreementsAgreementsGetResponseItemsItem && equalTo((PostV1AgreementsAgreementsGetResponseItemsItem) other);
  }
  ...
  private boolean equalTo(PostV1AgreementsAgreementsGetResponseItemsItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1AgreementsAgreementsGetResponseItemsItem other);
  }
  ...
  public interface _FinalStage {
    PostV1AgreementsAgreementsGetResponseItemsItem build();
  ...
  public static final class Builder implements IdStage, DescriptionStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PostV1AgreementsAgreementsGetResponseItemsItem other) {
      id(other.getId());
    ...
    @java.lang.Override
    public PostV1AgreementsAgreementsGetResponseItemsItem build() {
      return new PostV1AgreementsAgreementsGetResponseItemsItem(id, itemId, description, quantity, unitPrice, vatRatePercent, additionalProperties);
    }
