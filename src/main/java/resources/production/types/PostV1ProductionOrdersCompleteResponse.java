...
@JsonDeserialize(
    builder = PostV1ProductionOrdersCompleteResponse.Builder.class
)
public final class PostV1ProductionOrdersCompleteResponse {
  private final String id;

  private final PostV1ProductionOrdersCompleteResponseType type;
  ...
  private final PostV1ProductionOrdersCompleteResponseStatus status;
  ...
  private PostV1ProductionOrdersCompleteResponse(String id,
      PostV1ProductionOrdersCompleteResponseType type, String bomId, String warehouseId,
      Optional<String> routingId, String quantity, String date,
      PostV1ProductionOrdersCompleteResponseStatus status, Optional<String> scrappedQuantity,
  ...
  @JsonProperty("type")
  public PostV1ProductionOrdersCompleteResponseType getType() {
    return type;
  }
  ...
  @JsonProperty("status")
  public PostV1ProductionOrdersCompleteResponseStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1ProductionOrdersCompleteResponse && equalTo((PostV1ProductionOrdersCompleteResponse) other);
  }
  ...
  private boolean equalTo(PostV1ProductionOrdersCompleteResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1ProductionOrdersCompleteResponse other);
  }

  public interface TypeStage {
    BomIdStage type(@NotNull PostV1ProductionOrdersCompleteResponseType type);
  }
  ...
  public interface StatusStage {
    CreatedAtStage status(@NotNull PostV1ProductionOrdersCompleteResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1ProductionOrdersCompleteResponse build();
  ...
  public static final class Builder implements IdStage, TypeStage, BomIdStage, WarehouseIdStage, QuantityStage, DateStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    private PostV1ProductionOrdersCompleteResponseType type;
    ...
    private PostV1ProductionOrdersCompleteResponseStatus status;
    ...
    @java.lang.Override
    public Builder from(PostV1ProductionOrdersCompleteResponse other) {
      id(other.getId());
      type(other.getType());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public BomIdStage type(@NotNull PostV1ProductionOrdersCompleteResponseType type) {
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CreatedAtStage status(@NotNull PostV1ProductionOrdersCompleteResponseStatus status) {
    ...
    @java.lang.Override
    public PostV1ProductionOrdersCompleteResponse build() {
      return new PostV1ProductionOrdersCompleteResponse(id, type, bomId, warehouseId, routingId, quantity, date, status, scrappedQuantity, materialCost, laborCost, scrapCost, totalCost, journalTransactionId, notes, createdAt, additionalProperties);
    }
