...
public final class PostV1ProductionOrdersListResponseRowsItem {
  ...
  private PostV1ProductionOrdersListResponseRowsItem(String id,
      ...
      PostV1ProductionOrdersListResponseRowsItemStatus status, Optional<String> scrappedQuantity,
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.type, this.bomId, this.warehouseId, this.routingId, this.quantity, this.date, this.status, this.scrappedQuantity, this.materialCost, this.laborCost, this.scrapCost, this.totalCost, this.journalTransactionId, this.notes, this.createdAt);
  }
  ...
  public static final class Builder implements IdStage, TypeStage, BomIdStage, WarehouseIdStage, QuantityStage, DateStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    public PostV1ProductionOrdersListResponseRowsItem build() {
      return new PostV1ProductionOrdersListResponseRowsItem(id, type, bomId, warehouseId, routingId, quantity, date, status, scrappedQuantity, materialCost, laborCost, scrapCost, totalCost, journalTransactionId, notes, createdAt, additionalProperties);
    }
