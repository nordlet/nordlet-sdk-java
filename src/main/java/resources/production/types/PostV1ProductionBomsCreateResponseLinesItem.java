...
@JsonDeserialize(
    builder = PostV1ProductionBomsCreateResponseLinesItem.Builder.class
)
public final class PostV1ProductionBomsCreateResponseLinesItem {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1ProductionBomsCreateResponseLinesItem && equalTo((PostV1ProductionBomsCreateResponseLinesItem) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1ProductionBomsCreateResponseLinesItem other);
  }
  ...
  public interface _FinalStage {
    PostV1ProductionBomsCreateResponseLinesItem build();
  ...
  public static final class Builder implements IdStage, ComponentItemIdStage, QuantityStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PostV1ProductionBomsCreateResponseLinesItem other) {
      id(other.getId());
