...
@JsonDeserialize(
    builder = PostV1BankAccountsUpdateResponse.Builder.class
)
public final class PostV1BankAccountsUpdateResponse {
  ...
  private PostV1BankAccountsUpdateResponse(String id, String name, Optional<String> iban,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1BankAccountsUpdateResponse && equalTo((PostV1BankAccountsUpdateResponse) other);
  }
  ...
  private boolean equalTo(PostV1BankAccountsUpdateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1BankAccountsUpdateResponse other);
  }
  ...
  public interface _FinalStage {
    PostV1BankAccountsUpdateResponse build();
  ...
  public static final class Builder implements IdStage, NameStage, CurrencyStage, AccountCodeStage, IsActiveStage, CreatedAtStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PostV1BankAccountsUpdateResponse other) {
      id(other.getId());
      name(other.getName());
      iban(other.getIban());
    ...
    @java.lang.Override
    public PostV1BankAccountsUpdateResponse build() {
      return new PostV1BankAccountsUpdateResponse(id, name, iban, currency, accountCode, isActive, createdAt, additionalProperties);
    }
