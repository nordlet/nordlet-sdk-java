...
@JsonDeserialize(
    builder = PostV1BankFeedsConnectionsGetResponseAccountsItem.Builder.class
)
public final class PostV1BankFeedsConnectionsGetResponseAccountsItem {
  ...
  private final PostV1BankFeedsConnectionsGetResponseAccountsItemSyncSchedule syncSchedule;
  ...
  private PostV1BankFeedsConnectionsGetResponseAccountsItem(String id, String connectionId,
      Optional<String> bankAccountId, Optional<String> importTemplateId,
      PostV1BankFeedsConnectionsGetResponseAccountsItemSyncSchedule syncSchedule, String externalId,
  ...
  public PostV1BankFeedsConnectionsGetResponseAccountsItemSyncSchedule getSyncSchedule() {
    return syncSchedule;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1BankFeedsConnectionsGetResponseAccountsItem && equalTo((PostV1BankFeedsConnectionsGetResponseAccountsItem) other);
  }
  ...
  private boolean equalTo(PostV1BankFeedsConnectionsGetResponseAccountsItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1BankFeedsConnectionsGetResponseAccountsItem other);
  }
  ...
  public interface SyncScheduleStage {
    ExternalIdStage syncSchedule(
        @NotNull PostV1BankFeedsConnectionsGetResponseAccountsItemSyncSchedule syncSchedule);
  }
  ...
  public interface _FinalStage {
    PostV1BankFeedsConnectionsGetResponseAccountsItem build();
  ...
  public static final class Builder implements IdStage, ConnectionIdStage, SyncScheduleStage, ExternalIdStage, CurrencyStage, _FinalStage {
    ...
    private PostV1BankFeedsConnectionsGetResponseAccountsItemSyncSchedule syncSchedule;
    ...
    @java.lang.Override
    public Builder from(PostV1BankFeedsConnectionsGetResponseAccountsItem other) {
      id(other.getId());
    ...
    @java.lang.Override
    public PostV1BankFeedsConnectionsGetResponseAccountsItem build() {
      return new PostV1BankFeedsConnectionsGetResponseAccountsItem(id, connectionId, bankAccountId, importTemplateId, syncSchedule, externalId, iban, currency, name, product, syncFrom, lastSyncedAt, additionalProperties);
    }
