...
public final class PostV1BankFeedsConnectionsGetResponseAccountsItem {
  ...
  public static final class Builder implements IdStage, ConnectionIdStage, ExternalIdStage, CurrencyStage, _FinalStage {
    ...
    public PostV1BankFeedsConnectionsGetResponseAccountsItem build() {
      return new PostV1BankFeedsConnectionsGetResponseAccountsItem(id, connectionId, bankAccountId, externalId, iban, currency, name, product, syncFrom, lastSyncedAt, additionalProperties);
    }
