...
@JsonDeserialize(
    builder = PostV1BankAccountsCreateResponse.Builder.class
)
public final class PostV1BankAccountsCreateResponse {
  ...
  private PostV1BankAccountsCreateResponse(String id, String name, Optional<String> iban,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1BankAccountsCreateResponse && equalTo((PostV1BankAccountsCreateResponse) other);
  }
  ...
  private boolean equalTo(PostV1BankAccountsCreateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1BankAccountsCreateResponse other);
  }
  ...
  public interface _FinalStage {
    PostV1BankAccountsCreateResponse build();
  ...
  public static final class Builder implements IdStage, NameStage, CurrencyStage, AccountCodeStage, IsActiveStage, CreatedAtStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PostV1BankAccountsCreateResponse other) {
      id(other.getId());
      name(other.getName());
      iban(other.getIban());
    ...
    @java.lang.Override
    public PostV1BankAccountsCreateResponse build() {
      return new PostV1BankAccountsCreateResponse(id, name, iban, currency, accountCode, isActive, createdAt, additionalProperties);
    }
