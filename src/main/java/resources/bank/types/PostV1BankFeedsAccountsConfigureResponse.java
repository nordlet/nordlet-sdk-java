...
@JsonDeserialize(
    builder = PostV1BankFeedsAccountsConfigureResponse.Builder.class
)
public final class PostV1BankFeedsAccountsConfigureResponse {
  ...
  private final PostV1BankFeedsAccountsConfigureResponseSyncSchedule syncSchedule;
  ...
  private PostV1BankFeedsAccountsConfigureResponse(String id, String connectionId,
      Optional<String> bankAccountId, Optional<String> importTemplateId,
      PostV1BankFeedsAccountsConfigureResponseSyncSchedule syncSchedule, String externalId,
  ...
  public PostV1BankFeedsAccountsConfigureResponseSyncSchedule getSyncSchedule() {
    return syncSchedule;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1BankFeedsAccountsConfigureResponse && equalTo((PostV1BankFeedsAccountsConfigureResponse) other);
  }
  ...
  private boolean equalTo(PostV1BankFeedsAccountsConfigureResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1BankFeedsAccountsConfigureResponse other);
  }
  ...
  public interface SyncScheduleStage {
    ExternalIdStage syncSchedule(
        @NotNull PostV1BankFeedsAccountsConfigureResponseSyncSchedule syncSchedule);
  }
  ...
  public interface _FinalStage {
    PostV1BankFeedsAccountsConfigureResponse build();
  ...
  public static final class Builder implements IdStage, ConnectionIdStage, SyncScheduleStage, ExternalIdStage, CurrencyStage, _FinalStage {
    ...
    private PostV1BankFeedsAccountsConfigureResponseSyncSchedule syncSchedule;
    ...
    @java.lang.Override
    public Builder from(PostV1BankFeedsAccountsConfigureResponse other) {
      id(other.getId());
    ...
    @java.lang.Override
    public PostV1BankFeedsAccountsConfigureResponse build() {
      return new PostV1BankFeedsAccountsConfigureResponse(id, connectionId, bankAccountId, importTemplateId, syncSchedule, externalId, iban, currency, name, product, syncFrom, lastSyncedAt, additionalProperties);
    }
