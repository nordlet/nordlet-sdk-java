...
@JsonDeserialize(
    builder = PostV1BankSettlementsUnlinkResponse.Builder.class
)
public final class PostV1BankSettlementsUnlinkResponse {
  ...
  private final PostV1BankSettlementsUnlinkResponseStatus status;
  ...
  private PostV1BankSettlementsUnlinkResponse(String id, String bankAccountId, String provider,
      String payoutId, Optional<String> payoutDate, String currency, String grossTotal,
      String feeTotal, String netTotal, PostV1BankSettlementsUnlinkResponseStatus status,
  ...
  @JsonProperty("status")
  public PostV1BankSettlementsUnlinkResponseStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1BankSettlementsUnlinkResponse && equalTo((PostV1BankSettlementsUnlinkResponse) other);
  }
  ...
  private boolean equalTo(PostV1BankSettlementsUnlinkResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1BankSettlementsUnlinkResponse other);
  }
  ...
  public interface StatusStage {
    LineCountStage status(@NotNull PostV1BankSettlementsUnlinkResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1BankSettlementsUnlinkResponse build();
  ...
  public static final class Builder implements IdStage, BankAccountIdStage, ProviderStage, PayoutIdStage, CurrencyStage, GrossTotalStage, FeeTotalStage, NetTotalStage, StatusStage, LineCountStage, MatchedCountStage, UnmatchedCountStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1BankSettlementsUnlinkResponseStatus status;
    ...
    @java.lang.Override
    public Builder from(PostV1BankSettlementsUnlinkResponse other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public LineCountStage status(@NotNull PostV1BankSettlementsUnlinkResponseStatus status) {
    ...
    @java.lang.Override
    public PostV1BankSettlementsUnlinkResponse build() {
      return new PostV1BankSettlementsUnlinkResponse(id, bankAccountId, provider, payoutId, payoutDate, currency, grossTotal, feeTotal, netTotal, status, journalTransactionId, bankTransactionId, lineCount, matchedCount, unmatchedCount, createdAt, updatedAt, additionalProperties);
    }
