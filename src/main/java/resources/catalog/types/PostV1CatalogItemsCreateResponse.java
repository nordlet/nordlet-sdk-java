...
@JsonDeserialize(
    builder = PostV1CatalogItemsCreateResponse.Builder.class
)
public final class PostV1CatalogItemsCreateResponse {
  private final String id;

  private final PostV1CatalogItemsCreateResponseType type;

  private final PostV1CatalogItemsCreateResponseTracking tracking;
  ...
  private final Optional<Map<String, Optional<PostV1CatalogItemsCreateResponseTranslationsValue>>> translations;

  private final List<PostV1CatalogItemsCreateResponseComponentsItem> components;
  ...
  private PostV1CatalogItemsCreateResponse(String id, PostV1CatalogItemsCreateResponseType type,
      PostV1CatalogItemsCreateResponseTracking tracking, String name, Optional<String> code,
      ...
      Optional<Map<String, Optional<PostV1CatalogItemsCreateResponseTranslationsValue>>> translations,
      List<PostV1CatalogItemsCreateResponseComponentsItem> components, Optional<String> kindId,
      Optional<String> saleAccountCode, Optional<String> purchaseAccountCode,
      Optional<String> expenseAccountCode, Optional<String> manufacturer,
      Optional<String> grossMassKg, Optional<String> minQuantity, Optional<String> costPrice,
      boolean isFreePrice, Optional<String> externalId, boolean isReturnable,
      boolean commentRequired, Optional<String> priceFrom, Optional<String> priceTo,
      Optional<String> minPrice, Optional<String> discountPercent,
      ...
      Optional<Map<String, Optional<Boolean>>> posFlags, String createdAt, String updatedAt,
  ...
  @JsonProperty("type")
  public PostV1CatalogItemsCreateResponseType getType() {
    return type;
  }

  @JsonProperty("tracking")
  public PostV1CatalogItemsCreateResponseTracking getTracking() {
    return tracking;
  }
  ...
  @JsonIgnore
  public Optional<Map<String, Optional<PostV1CatalogItemsCreateResponseTranslationsValue>>> getTranslations(
      ) {
  ...
  public List<PostV1CatalogItemsCreateResponseComponentsItem> getComponents() {
    return components;
  }
  ...
  private Optional<Map<String, Optional<PostV1CatalogItemsCreateResponseTranslationsValue>>> _getTranslations(
      ) {
    return translations;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1CatalogItemsCreateResponse && equalTo((PostV1CatalogItemsCreateResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1CatalogItemsCreateResponse other);
  }

  public interface TypeStage {
    TrackingStage type(@NotNull PostV1CatalogItemsCreateResponseType type);
  }

  public interface TrackingStage {
    NameStage tracking(@NotNull PostV1CatalogItemsCreateResponseTracking tracking);
  }
  ...
  public interface UnitStage {
    IsFreePriceStage unit(@NotNull String unit);
  }

  public interface IsFreePriceStage {
    IsReturnableStage isFreePrice(boolean isFreePrice);
  }

  public interface IsReturnableStage {
    CommentRequiredStage isReturnable(boolean isReturnable);
  }

  public interface CommentRequiredStage {
    CreatedAtStage commentRequired(boolean commentRequired);
  }
  ...
  public interface _FinalStage {
    PostV1CatalogItemsCreateResponse build();
    ...
    _FinalStage translations(
        Map<String, Optional<PostV1CatalogItemsCreateResponseTranslationsValue>> translations);

    _FinalStage translations(
        Nullable<Map<String, Optional<PostV1CatalogItemsCreateResponseTranslationsValue>>> translations);

    _FinalStage components(List<PostV1CatalogItemsCreateResponseComponentsItem> components);

    _FinalStage addComponents(PostV1CatalogItemsCreateResponseComponentsItem components);

    _FinalStage addAllComponents(List<PostV1CatalogItemsCreateResponseComponentsItem> components);
  ...
  public static final class Builder implements IdStage, TypeStage, TrackingStage, NameStage, UnitStage, IsFreePriceStage, IsReturnableStage, CommentRequiredStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    private String id;

    private PostV1CatalogItemsCreateResponseType type;

    private PostV1CatalogItemsCreateResponseTracking tracking;
    ...
    private List<PostV1CatalogItemsCreateResponseComponentsItem> components = new ArrayList<>();

    private Optional<Map<String, Optional<PostV1CatalogItemsCreateResponseTranslationsValue>>> translations = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1CatalogItemsCreateResponse other) {
      id(other.getId());
      type(other.getType());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public TrackingStage type(@NotNull PostV1CatalogItemsCreateResponseType type) {
    ...
    @java.lang.Override
    @JsonSetter("tracking")
    public NameStage tracking(@NotNull PostV1CatalogItemsCreateResponseTracking tracking) {
    ...
    @java.lang.Override
    @JsonSetter("unit")
    public IsFreePriceStage unit(@NotNull String unit) {
      this.unit = Objects.requireNonNull(unit, "unit must not be null");
      return this;
    }

    @java.lang.Override
    @JsonSetter("isFreePrice")
    public IsReturnableStage isFreePrice(boolean isFreePrice) {
      this.isFreePrice = isFreePrice;
      return this;
    }

    @java.lang.Override
    @JsonSetter("isReturnable")
    public CommentRequiredStage isReturnable(boolean isReturnable) {
      this.isReturnable = isReturnable;
      return this;
    }

    @java.lang.Override
    @JsonSetter("commentRequired")
    public CreatedAtStage commentRequired(boolean commentRequired) {
      this.commentRequired = commentRequired;
      return this;
    }
    ...
    public _FinalStage addAllComponents(
        List<PostV1CatalogItemsCreateResponseComponentsItem> components) {
      if (components != null) {
    ...
    @java.lang.Override
    public _FinalStage addComponents(PostV1CatalogItemsCreateResponseComponentsItem components) {
    ...
    public _FinalStage components(List<PostV1CatalogItemsCreateResponseComponentsItem> components) {
    ...
    @java.lang.Override
    public PostV1CatalogItemsCreateResponse build() {
      return new PostV1CatalogItemsCreateResponse(id, type, tracking, name, code, barcode, unit, vatClassifierCode, vatRatePercent, salePriceExclVat, purchasePriceExclVat, cnCode, originCountry, netMassKg, supplementaryUnit, supplementaryQtyPerUnit, description, groupId, attributes, documentRef, translations, components, kindId, saleAccountCode, purchaseAccountCode, expenseAccountCode, manufacturer, grossMassKg, minQuantity, costPrice, isFreePrice, externalId, isReturnable, commentRequired, priceFrom, priceTo, minPrice, discountPercent, maxDiscountPercent, loyaltyPoints, department, ageRestriction, packageQuantity, taraCode, certificateNumber, certificateDate, validFrom, validTo, posFlags, createdAt, updatedAt, additionalProperties);
    }
