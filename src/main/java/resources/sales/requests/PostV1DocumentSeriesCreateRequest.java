...
import com.nordlet.api.resources.sales.types.PostV1DocumentSeriesCreateRequestDocumentType;
...
@JsonDeserialize(
    builder = PostV1DocumentSeriesCreateRequest.Builder.class
)
public final class PostV1DocumentSeriesCreateRequest {
  private final Optional<PostV1DocumentSeriesCreateRequestDocumentType> documentType;
  ...
  public Optional<PostV1DocumentSeriesCreateRequestDocumentType> getDocumentType() {
    return documentType;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1DocumentSeriesCreateRequest && equalTo((PostV1DocumentSeriesCreateRequest) other);
  }
  ...
  public interface PrefixStage {
    ...
    Builder from(PostV1DocumentSeriesCreateRequest other);
  }

  public interface _FinalStage {
    PostV1DocumentSeriesCreateRequest build();

    _FinalStage additionalProperty(String key, Object value);

    _FinalStage additionalProperties(Map<String, Object> additionalProperties);

    _FinalStage documentType(Optional<PostV1DocumentSeriesCreateRequestDocumentType> documentType);

    _FinalStage documentType(PostV1DocumentSeriesCreateRequestDocumentType documentType);
  ...
  public static final class Builder implements PrefixStage, _FinalStage {
    ...
    private Optional<PostV1DocumentSeriesCreateRequestDocumentType> documentType = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1DocumentSeriesCreateRequest other) {
    ...
    @java.lang.Override
    public _FinalStage documentType(PostV1DocumentSeriesCreateRequestDocumentType documentType) {
    ...
    public _FinalStage documentType(
        Optional<PostV1DocumentSeriesCreateRequestDocumentType> documentType) {
      this.documentType = documentType;
      return this;
    }
