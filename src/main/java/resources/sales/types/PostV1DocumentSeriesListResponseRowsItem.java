...
@JsonDeserialize(
    builder = PostV1DocumentSeriesListResponseRowsItem.Builder.class
)
public final class PostV1DocumentSeriesListResponseRowsItem {
  ...
  private PostV1DocumentSeriesListResponseRowsItem(String id, String documentType, String prefix,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1DocumentSeriesListResponseRowsItem && equalTo((PostV1DocumentSeriesListResponseRowsItem) other);
  }
  ...
  private boolean equalTo(PostV1DocumentSeriesListResponseRowsItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1DocumentSeriesListResponseRowsItem other);
  }
  ...
  public interface _FinalStage {
    PostV1DocumentSeriesListResponseRowsItem build();
  ...
  public static final class Builder implements IdStage, DocumentTypeStage, PrefixStage, NumberLengthStage, NextNumberStage, PrintSeriesStage, IsDefaultStage, IsActiveStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PostV1DocumentSeriesListResponseRowsItem other) {
      id(other.getId());
    ...
    @java.lang.Override
    public PostV1DocumentSeriesListResponseRowsItem build() {
      return new PostV1DocumentSeriesListResponseRowsItem(id, documentType, prefix, name, label, operationTypeId, numberLength, nextNumber, warehouseId, printSeries, isDefault, isActive, createdAt, updatedAt, additionalProperties);
    }
