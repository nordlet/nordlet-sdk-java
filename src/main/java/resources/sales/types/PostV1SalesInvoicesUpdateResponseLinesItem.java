...
@JsonDeserialize(
    builder = PostV1SalesInvoicesUpdateResponseLinesItem.Builder.class
)
public final class PostV1SalesInvoicesUpdateResponseLinesItem {
  ...
  private final PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod recognitionMethod;

  private final Optional<String> recognitionStartDate;

  private final Optional<String> recognitionEndDate;

  private final Optional<List<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones;
  ...
  private PostV1SalesInvoicesUpdateResponseLinesItem(String id, Optional<String> itemId,
      ...
      PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod recognitionMethod,
      Optional<String> recognitionStartDate, Optional<String> recognitionEndDate,
      Optional<List<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones,
  ...
  public PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod getRecognitionMethod() {
  ...
  @JsonIgnore
  public Optional<List<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem>> getRecognitionMilestones(
      ) {
  ...
  private Optional<List<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem>> _getRecognitionMilestones(
      ) {
    return recognitionMilestones;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1SalesInvoicesUpdateResponseLinesItem && equalTo((PostV1SalesInvoicesUpdateResponseLinesItem) other);
  }
  ...
  private boolean equalTo(PostV1SalesInvoicesUpdateResponseLinesItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1SalesInvoicesUpdateResponseLinesItem other);
  }
  ...
  public interface RecognitionMethodStage {
    _FinalStage recognitionMethod(
        @NotNull PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod recognitionMethod);
  }

  public interface _FinalStage {
    PostV1SalesInvoicesUpdateResponseLinesItem build();
    ...
    _FinalStage recognitionMilestones(
        List<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem> recognitionMilestones);

    _FinalStage recognitionMilestones(
        Nullable<List<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones);
  ...
  public static final class Builder implements IdStage, DescriptionStage, UnitStage, QuantityStage, VatRatePercentStage, LineNetStage, LineVatStage, LineGrossStage, SortOrderStage, RecognitionMethodStage, _FinalStage {
    ...
    private PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod recognitionMethod;
    ...
    private Optional<List<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1SalesInvoicesUpdateResponseLinesItem other) {
      id(other.getId());
    ...
    @java.lang.Override
    public PostV1SalesInvoicesUpdateResponseLinesItem build() {
      return new PostV1SalesInvoicesUpdateResponseLinesItem(id, itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, projectId, lineNet, lineVat, lineGross, sortOrder, recognitionMethod, recognitionStartDate, recognitionEndDate, recognitionMilestones, standaloneSellingPrice, allocatedNet, refundEstimatePercent, additionalProperties);
    }
