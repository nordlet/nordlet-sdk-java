...
@JsonDeserialize(
    builder = PostV1SalesInvoicesGetResponseLinesItem.Builder.class
)
public final class PostV1SalesInvoicesGetResponseLinesItem {
  ...
  private final PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod recognitionMethod;

  private final Optional<String> recognitionStartDate;

  private final Optional<String> recognitionEndDate;

  private final Optional<List<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones;
  ...
  private PostV1SalesInvoicesGetResponseLinesItem(String id, Optional<String> itemId,
      ...
      long sortOrder, PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod recognitionMethod,
      Optional<String> recognitionStartDate, Optional<String> recognitionEndDate,
      Optional<List<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones,
  ...
  public PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod getRecognitionMethod() {
  ...
  @JsonIgnore
  public Optional<List<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>> getRecognitionMilestones(
      ) {
  ...
  private Optional<List<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>> _getRecognitionMilestones(
      ) {
    return recognitionMilestones;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1SalesInvoicesGetResponseLinesItem && equalTo((PostV1SalesInvoicesGetResponseLinesItem) other);
  }
  ...
  private boolean equalTo(PostV1SalesInvoicesGetResponseLinesItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1SalesInvoicesGetResponseLinesItem other);
  }
  ...
  public interface RecognitionMethodStage {
    _FinalStage recognitionMethod(
        @NotNull PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod recognitionMethod);
  }

  public interface _FinalStage {
    PostV1SalesInvoicesGetResponseLinesItem build();
    ...
    _FinalStage recognitionMilestones(
        List<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem> recognitionMilestones);

    _FinalStage recognitionMilestones(
        Nullable<List<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones);
  ...
  public static final class Builder implements IdStage, DescriptionStage, UnitStage, QuantityStage, VatRatePercentStage, LineNetStage, LineVatStage, LineGrossStage, SortOrderStage, RecognitionMethodStage, _FinalStage {
    ...
    private PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod recognitionMethod;
    ...
    private Optional<List<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1SalesInvoicesGetResponseLinesItem other) {
      id(other.getId());
    ...
    @java.lang.Override
    public PostV1SalesInvoicesGetResponseLinesItem build() {
      return new PostV1SalesInvoicesGetResponseLinesItem(id, itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, lineNet, lineVat, lineGross, sortOrder, recognitionMethod, recognitionStartDate, recognitionEndDate, recognitionMilestones, standaloneSellingPrice, allocatedNet, refundEstimatePercent, additionalProperties);
    }
