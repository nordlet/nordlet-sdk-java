...
public final class PostV1SalesInvoicesGetResponseLinesItem {
  ...
  private PostV1SalesInvoicesGetResponseLinesItem(String id, Optional<String> itemId,
      ...
      PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod recognitionMethod,
  ...
  public static final class Builder implements IdStage, DescriptionStage, UnitStage, QuantityStage, VatRatePercentStage, LineNetStage, LineVatStage, LineGrossStage, SortOrderStage, RecognitionMethodStage, _FinalStage {
    ...
    public PostV1SalesInvoicesGetResponseLinesItem build() {
      return new PostV1SalesInvoicesGetResponseLinesItem(id, itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, projectId, lineNet, lineVat, lineGross, sortOrder, recognitionMethod, recognitionStartDate, recognitionEndDate, recognitionMilestones, standaloneSellingPrice, allocatedNet, refundEstimatePercent, additionalProperties);
    }
