...
public final class PostV1SalesActsPdfRequestLocale {
  ...
  PostV1SalesActsPdfRequestLocale(Value value, String string) {
    this.value = value;
    this.string = string;
  }
  ...
  public boolean equals(Object other) {
    return (this == other) 
      || (other instanceof PostV1SalesActsPdfRequestLocale && this.string.equals(((PostV1SalesActsPdfRequestLocale) other).string));
  }
  ...
  public static PostV1SalesActsPdfRequestLocale valueOf(String value) {
    switch (value) {
      case "en":
        return EN;
      case "lt":
