...
@JsonDeserialize(
    builder = PostV1SalesInvoicesCreateRequestLinesItem.Builder.class
)
public final class PostV1SalesInvoicesCreateRequestLinesItem {
  ...
  private final Optional<PostV1SalesInvoicesCreateRequestLinesItemQuantity> quantity;
  ...
  private PostV1SalesInvoicesCreateRequestLinesItem(Optional<String> itemId,
      Optional<String> description, Optional<String> unit,
      Optional<PostV1SalesInvoicesCreateRequestLinesItemQuantity> quantity,
  ...
  public Optional<PostV1SalesInvoicesCreateRequestLinesItemQuantity> getQuantity() {
    return quantity;
  }
  ...
  public Optional<PostV1SalesInvoicesCreateRequestLinesItemRecognition> getRecognition() {
    return recognition;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1SalesInvoicesCreateRequestLinesItem && equalTo((PostV1SalesInvoicesCreateRequestLinesItem) other);
  }
  ...
  public static final class Builder {
    ...
    private Optional<PostV1SalesInvoicesCreateRequestLinesItemQuantity> quantity = Optional.empty();
    ...
    public Builder from(PostV1SalesInvoicesCreateRequestLinesItem other) {
    ...
    public Builder quantity(Optional<PostV1SalesInvoicesCreateRequestLinesItemQuantity> quantity) {
      this.quantity = quantity;
      return this;
    }

    public Builder quantity(PostV1SalesInvoicesCreateRequestLinesItemQuantity quantity) {
    ...
    public Builder recognition(
        Optional<PostV1SalesInvoicesCreateRequestLinesItemRecognition> recognition) {
      this.recognition = recognition;
      return this;
    }

    public Builder recognition(PostV1SalesInvoicesCreateRequestLinesItemRecognition recognition) {
      this.recognition = Optional.ofNullable(recognition);
      return this;
    }
    ...
    public Builder standaloneSellingPrice(Optional<String> standaloneSellingPrice) {
      this.standaloneSellingPrice = standaloneSellingPrice;
      return this;
    }

    public Builder standaloneSellingPrice(String standaloneSellingPrice) {
    ...
    public Builder refundEstimatePercent(Optional<String> refundEstimatePercent) {
      this.refundEstimatePercent = refundEstimatePercent;
      return this;
    }

    public Builder refundEstimatePercent(String refundEstimatePercent) {
    ...
    public PostV1SalesInvoicesCreateRequestLinesItem build() {
      return new PostV1SalesInvoicesCreateRequestLinesItem(itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, recognition, standaloneSellingPrice, refundEstimatePercent, additionalProperties);
    }
