...
@JsonDeserialize(
    builder = PostV1SalesInvoicesLockResponseLinesItem.Builder.class
)
public final class PostV1SalesInvoicesLockResponseLinesItem {
  ...
  private final PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod recognitionMethod;

  private final Optional<String> recognitionStartDate;

  private final Optional<String> recognitionEndDate;

  private final Optional<List<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones;
  ...
  private PostV1SalesInvoicesLockResponseLinesItem(String id, Optional<String> itemId,
      ...
      PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod recognitionMethod,
      Optional<String> recognitionStartDate, Optional<String> recognitionEndDate,
      Optional<List<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones,
  ...
  public PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod getRecognitionMethod() {
  ...
  @JsonIgnore
  public Optional<List<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>> getRecognitionMilestones(
      ) {
  ...
  private Optional<List<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>> _getRecognitionMilestones(
      ) {
    return recognitionMilestones;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1SalesInvoicesLockResponseLinesItem && equalTo((PostV1SalesInvoicesLockResponseLinesItem) other);
  }
  ...
  private boolean equalTo(PostV1SalesInvoicesLockResponseLinesItem other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1SalesInvoicesLockResponseLinesItem other);
  }
  ...
  public interface RecognitionMethodStage {
    _FinalStage recognitionMethod(
        @NotNull PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod recognitionMethod);
  }

  public interface _FinalStage {
    PostV1SalesInvoicesLockResponseLinesItem build();
    ...
    _FinalStage recognitionMilestones(
        List<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem> recognitionMilestones);

    _FinalStage recognitionMilestones(
        Nullable<List<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones);
  ...
  public static final class Builder implements IdStage, DescriptionStage, UnitStage, QuantityStage, VatRatePercentStage, LineNetStage, LineVatStage, LineGrossStage, SortOrderStage, RecognitionMethodStage, _FinalStage {
    ...
    private PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod recognitionMethod;
    ...
    private Optional<List<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>> recognitionMilestones = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1SalesInvoicesLockResponseLinesItem other) {
      id(other.getId());
    ...
    @java.lang.Override
    public PostV1SalesInvoicesLockResponseLinesItem build() {
      return new PostV1SalesInvoicesLockResponseLinesItem(id, itemId, description, unit, quantity, unitPriceExclVat, unitPriceInclVat, vatRatePercent, vatClassifierCode, costCenterId, projectId, lineNet, lineVat, lineGross, sortOrder, recognitionMethod, recognitionStartDate, recognitionEndDate, recognitionMilestones, standaloneSellingPrice, allocatedNet, refundEstimatePercent, additionalProperties);
    }
