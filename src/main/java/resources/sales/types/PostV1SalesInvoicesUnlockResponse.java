...
@JsonDeserialize(
    builder = PostV1SalesInvoicesUnlockResponse.Builder.class
)
public final class PostV1SalesInvoicesUnlockResponse {
  private final String id;

  private final String partnerId;

  private final PostV1SalesInvoicesUnlockResponseType type;

  private final PostV1SalesInvoicesUnlockResponseStatus status;

  private final PostV1SalesInvoicesUnlockResponsePaymentStatus paymentStatus;
  ...
  private final Optional<PostV1SalesInvoicesUnlockResponseVatScheme> vatScheme;
  ...
  private final List<PostV1SalesInvoicesUnlockResponseLinesItem> lines;

  private final Optional<PostV1SalesInvoicesUnlockResponseVatEvidence> vatEvidence;

  private final Map<String, Object> additionalProperties;

  private PostV1SalesInvoicesUnlockResponse(String id, String partnerId,
      PostV1SalesInvoicesUnlockResponseType type, PostV1SalesInvoicesUnlockResponseStatus status,
      PostV1SalesInvoicesUnlockResponsePaymentStatus paymentStatus, Optional<String> series,
      ...
      Optional<String> agreementId, Optional<PostV1SalesInvoicesUnlockResponseVatScheme> vatScheme,
      ...
      List<PostV1SalesInvoicesUnlockResponseLinesItem> lines,
      Optional<PostV1SalesInvoicesUnlockResponseVatEvidence> vatEvidence,
  ...
  @JsonProperty("type")
  public PostV1SalesInvoicesUnlockResponseType getType() {
    return type;
  }

  @JsonProperty("status")
  public PostV1SalesInvoicesUnlockResponseStatus getStatus() {
    return status;
  }

  @JsonProperty("paymentStatus")
  public PostV1SalesInvoicesUnlockResponsePaymentStatus getPaymentStatus() {
  ...
  @JsonIgnore
  public Optional<PostV1SalesInvoicesUnlockResponseVatScheme> getVatScheme() {
    if (vatScheme == null) {
      return Optional.empty();
    }
    return vatScheme;
  ...
  @JsonProperty("lines")
  public List<PostV1SalesInvoicesUnlockResponseLinesItem> getLines() {
    return lines;
  }

  @JsonIgnore
  public Optional<PostV1SalesInvoicesUnlockResponseVatEvidence> getVatEvidence() {
    if (vatEvidence == null) {
      return Optional.empty();
    }
    return vatEvidence;
  ...
  private Optional<PostV1SalesInvoicesUnlockResponseVatScheme> _getVatScheme() {
    return vatScheme;
  }
  ...
  private Optional<PostV1SalesInvoicesUnlockResponseVatEvidence> _getVatEvidence() {
    return vatEvidence;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1SalesInvoicesUnlockResponse && equalTo((PostV1SalesInvoicesUnlockResponse) other);
  }
  ...
  private boolean equalTo(PostV1SalesInvoicesUnlockResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1SalesInvoicesUnlockResponse other);
  }
  ...
  public interface TypeStage {
    StatusStage type(@NotNull PostV1SalesInvoicesUnlockResponseType type);
  }

  public interface StatusStage {
    PaymentStatusStage status(@NotNull PostV1SalesInvoicesUnlockResponseStatus status);
  }

  public interface PaymentStatusStage {
    CurrencyStage paymentStatus(
        @NotNull PostV1SalesInvoicesUnlockResponsePaymentStatus paymentStatus);
  }
  ...
  public interface _FinalStage {
    PostV1SalesInvoicesUnlockResponse build();
    ...
    _FinalStage vatScheme(Optional<PostV1SalesInvoicesUnlockResponseVatScheme> vatScheme);

    _FinalStage vatScheme(PostV1SalesInvoicesUnlockResponseVatScheme vatScheme);

    _FinalStage vatScheme(Nullable<PostV1SalesInvoicesUnlockResponseVatScheme> vatScheme);
    ...
    _FinalStage lines(List<PostV1SalesInvoicesUnlockResponseLinesItem> lines);

    _FinalStage addLines(PostV1SalesInvoicesUnlockResponseLinesItem lines);

    _FinalStage addAllLines(List<PostV1SalesInvoicesUnlockResponseLinesItem> lines);

    _FinalStage vatEvidence(Optional<PostV1SalesInvoicesUnlockResponseVatEvidence> vatEvidence);

    _FinalStage vatEvidence(PostV1SalesInvoicesUnlockResponseVatEvidence vatEvidence);

    _FinalStage vatEvidence(Nullable<PostV1SalesInvoicesUnlockResponseVatEvidence> vatEvidence);
  }
  ...
  public static final class Builder implements IdStage, PartnerIdStage, TypeStage, StatusStage, PaymentStatusStage, CurrencyStage, NetTotalStage, VatTotalStage, GrossTotalStage, PaidAmountStage, DeemedSupplierStage, DiscountPercentStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1SalesInvoicesUnlockResponseType type;

    private PostV1SalesInvoicesUnlockResponseStatus status;

    private PostV1SalesInvoicesUnlockResponsePaymentStatus paymentStatus;
    ...
    private Optional<PostV1SalesInvoicesUnlockResponseVatEvidence> vatEvidence = Optional.empty();

    private List<PostV1SalesInvoicesUnlockResponseLinesItem> lines = new ArrayList<>();
    ...
    private Optional<PostV1SalesInvoicesUnlockResponseVatScheme> vatScheme = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1SalesInvoicesUnlockResponse other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public StatusStage type(@NotNull PostV1SalesInvoicesUnlockResponseType type) {
    ...
    @java.lang.Override
    @JsonSetter("status")
    public PaymentStatusStage status(@NotNull PostV1SalesInvoicesUnlockResponseStatus status) {
    ...
    public _FinalStage vatEvidence(
        Nullable<PostV1SalesInvoicesUnlockResponseVatEvidence> vatEvidence) {
    ...
    @java.lang.Override
    public _FinalStage vatEvidence(PostV1SalesInvoicesUnlockResponseVatEvidence vatEvidence) {
    ...
    @java.lang.Override
    public _FinalStage addAllLines(List<PostV1SalesInvoicesUnlockResponseLinesItem> lines) {
      if (lines != null) {
    ...
    @java.lang.Override
    public _FinalStage addLines(PostV1SalesInvoicesUnlockResponseLinesItem lines) {
    ...
    public _FinalStage lines(List<PostV1SalesInvoicesUnlockResponseLinesItem> lines) {
      this.lines.clear();
      if (lines != null) {
        this.lines.addAll(lines);
      }
    ...
    @java.lang.Override
    public _FinalStage vatScheme(Nullable<PostV1SalesInvoicesUnlockResponseVatScheme> vatScheme) {
      if (vatScheme.isNull()) {
        this.vatScheme = null;
      }
    ...
    @java.lang.Override
    public _FinalStage vatScheme(PostV1SalesInvoicesUnlockResponseVatScheme vatScheme) {
    ...
    public _FinalStage vatScheme(Optional<PostV1SalesInvoicesUnlockResponseVatScheme> vatScheme) {
      this.vatScheme = vatScheme;
      return this;
    }
