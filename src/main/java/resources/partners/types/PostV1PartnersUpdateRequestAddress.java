...
@JsonDeserialize(
    builder = PostV1PartnersUpdateRequestAddress.Builder.class
)
public final class PostV1PartnersUpdateRequestAddress {
  ...
  private PostV1PartnersUpdateRequestAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersUpdateRequestAddress && equalTo((PostV1PartnersUpdateRequestAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersUpdateRequestAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersUpdateRequestAddress other) {
    ...
    public PostV1PartnersUpdateRequestAddress build() {
      return new PostV1PartnersUpdateRequestAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
