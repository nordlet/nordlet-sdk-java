...
@JsonDeserialize(
    builder = PostV1PartnersUpdateResponseCorrespondenceAddress.Builder.class
)
public final class PostV1PartnersUpdateResponseCorrespondenceAddress {
  ...
  private PostV1PartnersUpdateResponseCorrespondenceAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersUpdateResponseCorrespondenceAddress && equalTo((PostV1PartnersUpdateResponseCorrespondenceAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersUpdateResponseCorrespondenceAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersUpdateResponseCorrespondenceAddress other) {
    ...
    public PostV1PartnersUpdateResponseCorrespondenceAddress build() {
      return new PostV1PartnersUpdateResponseCorrespondenceAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
