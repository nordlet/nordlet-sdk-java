...
@JsonDeserialize(
    builder = PostV1PartnersUpdateRequestCorrespondenceAddress.Builder.class
)
public final class PostV1PartnersUpdateRequestCorrespondenceAddress {
  ...
  private PostV1PartnersUpdateRequestCorrespondenceAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersUpdateRequestCorrespondenceAddress && equalTo((PostV1PartnersUpdateRequestCorrespondenceAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersUpdateRequestCorrespondenceAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersUpdateRequestCorrespondenceAddress other) {
    ...
    public PostV1PartnersUpdateRequestCorrespondenceAddress build() {
      return new PostV1PartnersUpdateRequestCorrespondenceAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
