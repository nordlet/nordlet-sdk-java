...
@JsonDeserialize(
    builder = PostV1PartnersGetResponseAddress.Builder.class
)
public final class PostV1PartnersGetResponseAddress {
  ...
  private PostV1PartnersGetResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersGetResponseAddress && equalTo((PostV1PartnersGetResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersGetResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersGetResponseAddress other) {
    ...
    public PostV1PartnersGetResponseAddress build() {
      return new PostV1PartnersGetResponseAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
