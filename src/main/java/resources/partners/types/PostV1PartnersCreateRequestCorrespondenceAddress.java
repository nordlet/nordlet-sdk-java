...
@JsonDeserialize(
    builder = PostV1PartnersCreateRequestCorrespondenceAddress.Builder.class
)
public final class PostV1PartnersCreateRequestCorrespondenceAddress {
  ...
  private PostV1PartnersCreateRequestCorrespondenceAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersCreateRequestCorrespondenceAddress && equalTo((PostV1PartnersCreateRequestCorrespondenceAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersCreateRequestCorrespondenceAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersCreateRequestCorrespondenceAddress other) {
    ...
    public PostV1PartnersCreateRequestCorrespondenceAddress build() {
      return new PostV1PartnersCreateRequestCorrespondenceAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
