...
@JsonDeserialize(
    builder = PostV1PartnersCreateResponse.Builder.class
)
public final class PostV1PartnersCreateResponse {
  private final String id;

  private final PostV1PartnersCreateResponseType type;
  ...
  private final Optional<PostV1PartnersCreateResponseAddress> address;

  private final Optional<PostV1PartnersCreateResponseCorrespondenceAddress> correspondenceAddress;
  ...
  private final Optional<PostV1PartnersCreateResponseLegalCountryClass> legalCountryClass;
  ...
  private PostV1PartnersCreateResponse(String id, PostV1PartnersCreateResponseType type,
      ...
      Optional<String> vatValidatedAt, Optional<PostV1PartnersCreateResponseAddress> address,
      Optional<PostV1PartnersCreateResponseCorrespondenceAddress> correspondenceAddress,
      ...
      Optional<PostV1PartnersCreateResponseLegalCountryClass> legalCountryClass, String createdAt,
  ...
  @JsonProperty("type")
  public PostV1PartnersCreateResponseType getType() {
    return type;
  }
  ...
  @JsonIgnore
  public Optional<PostV1PartnersCreateResponseAddress> getAddress() {
    if (address == null) {
      return Optional.empty();
    }
    return address;
  ...
  @JsonIgnore
  public Optional<PostV1PartnersCreateResponseCorrespondenceAddress> getCorrespondenceAddress() {
  ...
  @JsonIgnore
  public Optional<PostV1PartnersCreateResponseLegalCountryClass> getLegalCountryClass() {
  ...
  private Optional<PostV1PartnersCreateResponseAddress> _getAddress() {
    return address;
  }
  ...
  private Optional<PostV1PartnersCreateResponseCorrespondenceAddress> _getCorrespondenceAddress() {
    return correspondenceAddress;
  }
  ...
  private Optional<PostV1PartnersCreateResponseLegalCountryClass> _getLegalCountryClass() {
    return legalCountryClass;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersCreateResponse && equalTo((PostV1PartnersCreateResponse) other);
  }
  ...
  private boolean equalTo(PostV1PartnersCreateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1PartnersCreateResponse other);
  }

  public interface TypeStage {
    NameStage type(@NotNull PostV1PartnersCreateResponseType type);
  }
  ...
  public interface _FinalStage {
    PostV1PartnersCreateResponse build();
    ...
    _FinalStage address(Optional<PostV1PartnersCreateResponseAddress> address);

    _FinalStage address(PostV1PartnersCreateResponseAddress address);

    _FinalStage address(Nullable<PostV1PartnersCreateResponseAddress> address);

    _FinalStage correspondenceAddress(
        Optional<PostV1PartnersCreateResponseCorrespondenceAddress> correspondenceAddress);

    _FinalStage correspondenceAddress(
        PostV1PartnersCreateResponseCorrespondenceAddress correspondenceAddress);

    _FinalStage correspondenceAddress(
        Nullable<PostV1PartnersCreateResponseCorrespondenceAddress> correspondenceAddress);
    ...
    _FinalStage legalCountryClass(
        Optional<PostV1PartnersCreateResponseLegalCountryClass> legalCountryClass);

    _FinalStage legalCountryClass(PostV1PartnersCreateResponseLegalCountryClass legalCountryClass);

    _FinalStage legalCountryClass(
        Nullable<PostV1PartnersCreateResponseLegalCountryClass> legalCountryClass);
  }
  ...
  public static final class Builder implements IdStage, TypeStage, NameStage, IsCustomerStage, IsSupplierStage, AutoDebtReminderStage, IsEmployeeStage, IsGroupMemberStage, IsActiveStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1PartnersCreateResponseType type;
    ...
    private Optional<PostV1PartnersCreateResponseLegalCountryClass> legalCountryClass = Optional.empty();
    ...
    private Optional<PostV1PartnersCreateResponseCorrespondenceAddress> correspondenceAddress = Optional.empty();

    private Optional<PostV1PartnersCreateResponseAddress> address = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1PartnersCreateResponse other) {
      id(other.getId());
      type(other.getType());
      name(other.getName());
      code(other.getCode());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public NameStage type(@NotNull PostV1PartnersCreateResponseType type) {
    ...
    @java.lang.Override
    public _FinalStage legalCountryClass(
        PostV1PartnersCreateResponseLegalCountryClass legalCountryClass) {
    ...
    @java.lang.Override
    public _FinalStage address(Nullable<PostV1PartnersCreateResponseAddress> address) {
      if (address.isNull()) {
        this.address = null;
      }
    ...
    @java.lang.Override
    public _FinalStage address(PostV1PartnersCreateResponseAddress address) {
    ...
    public _FinalStage address(Optional<PostV1PartnersCreateResponseAddress> address) {
      this.address = address;
      return this;
    }
