...
@JsonDeserialize(
    builder = PostV1LeadsCreateResponse.Builder.class
)
public final class PostV1LeadsCreateResponse {
  ...
  private final PostV1LeadsCreateResponseStatus status;
  ...
  private PostV1LeadsCreateResponse(String id, String name, Optional<String> contactName,
      ...
      PostV1LeadsCreateResponseStatus status, Optional<String> estimatedValue, String currency,
  ...
  @JsonProperty("status")
  public PostV1LeadsCreateResponseStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LeadsCreateResponse && equalTo((PostV1LeadsCreateResponse) other);
  }
  ...
  private boolean equalTo(PostV1LeadsCreateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1LeadsCreateResponse other);
  }
  ...
  public interface StatusStage {
    CurrencyStage status(@NotNull PostV1LeadsCreateResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1LeadsCreateResponse build();
  ...
  public static final class Builder implements IdStage, NameStage, StatusStage, CurrencyStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1LeadsCreateResponseStatus status;
    ...
    @java.lang.Override
    public Builder from(PostV1LeadsCreateResponse other) {
      id(other.getId());
      name(other.getName());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CurrencyStage status(@NotNull PostV1LeadsCreateResponseStatus status) {
    ...
    @java.lang.Override
    public PostV1LeadsCreateResponse build() {
      return new PostV1LeadsCreateResponse(id, name, contactName, email, phone, website, countryCode, sourceId, sourceName, status, estimatedValue, currency, description, assignedUserId, partnerId, convertedAt, createdAt, updatedAt, additionalProperties);
    }
