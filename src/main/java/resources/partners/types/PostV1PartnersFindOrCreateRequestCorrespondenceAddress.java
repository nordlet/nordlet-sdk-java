...
@JsonDeserialize(
    builder = PostV1PartnersFindOrCreateRequestCorrespondenceAddress.Builder.class
)
public final class PostV1PartnersFindOrCreateRequestCorrespondenceAddress {
  ...
  private PostV1PartnersFindOrCreateRequestCorrespondenceAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersFindOrCreateRequestCorrespondenceAddress && equalTo((PostV1PartnersFindOrCreateRequestCorrespondenceAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersFindOrCreateRequestCorrespondenceAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersFindOrCreateRequestCorrespondenceAddress other) {
    ...
    public PostV1PartnersFindOrCreateRequestCorrespondenceAddress build() {
      return new PostV1PartnersFindOrCreateRequestCorrespondenceAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
