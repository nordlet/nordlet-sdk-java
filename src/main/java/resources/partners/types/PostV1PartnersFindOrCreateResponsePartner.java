...
@JsonDeserialize(
    builder = PostV1PartnersFindOrCreateResponsePartner.Builder.class
)
public final class PostV1PartnersFindOrCreateResponsePartner {
  private final String id;

  private final PostV1PartnersFindOrCreateResponsePartnerType type;
  ...
  private final Optional<PostV1PartnersFindOrCreateResponsePartnerAddress> address;

  private final Optional<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress> correspondenceAddress;
  ...
  private final Optional<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass> legalCountryClass;
  ...
  private PostV1PartnersFindOrCreateResponsePartner(String id,
      PostV1PartnersFindOrCreateResponsePartnerType type, String name, Optional<String> code,
      Optional<String> vatCode, Optional<String> peppolId, Optional<String> email,
      Optional<String> phone, Optional<String> selfEmploymentCertNo, Optional<String> birthDate,
      boolean isCustomer, boolean isSupplier, Optional<Long> paymentTermDays,
      ...
      Optional<PostV1PartnersFindOrCreateResponsePartnerAddress> address,
      Optional<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress> correspondenceAddress,
      ...
      Optional<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass> legalCountryClass,
  ...
  @JsonProperty("type")
  public PostV1PartnersFindOrCreateResponsePartnerType getType() {
    return type;
  }
  ...
  @JsonIgnore
  public Optional<PostV1PartnersFindOrCreateResponsePartnerAddress> getAddress() {
    if (address == null) {
      return Optional.empty();
    }
    return address;
  ...
  @JsonIgnore
  public Optional<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress> getCorrespondenceAddress(
      ) {
  ...
  @JsonIgnore
  public Optional<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass> getLegalCountryClass(
      ) {
  ...
  private Optional<PostV1PartnersFindOrCreateResponsePartnerAddress> _getAddress() {
    return address;
  }
  ...
  private Optional<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress> _getCorrespondenceAddress(
      ) {
    return correspondenceAddress;
  }
  ...
  private Optional<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass> _getLegalCountryClass(
      ) {
    return legalCountryClass;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersFindOrCreateResponsePartner && equalTo((PostV1PartnersFindOrCreateResponsePartner) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PostV1PartnersFindOrCreateResponsePartner other);
  }

  public interface TypeStage {
    NameStage type(@NotNull PostV1PartnersFindOrCreateResponsePartnerType type);
  }
  ...
  public interface _FinalStage {
    PostV1PartnersFindOrCreateResponsePartner build();
    ...
    _FinalStage address(Optional<PostV1PartnersFindOrCreateResponsePartnerAddress> address);

    _FinalStage address(PostV1PartnersFindOrCreateResponsePartnerAddress address);

    _FinalStage address(Nullable<PostV1PartnersFindOrCreateResponsePartnerAddress> address);

    _FinalStage correspondenceAddress(
        Optional<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress> correspondenceAddress);

    _FinalStage correspondenceAddress(
        PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress correspondenceAddress);

    _FinalStage correspondenceAddress(
        Nullable<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress> correspondenceAddress);
    ...
    _FinalStage legalCountryClass(
        PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass legalCountryClass);

    _FinalStage legalCountryClass(
        Nullable<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass> legalCountryClass);
  }
  ...
  public static final class Builder implements IdStage, TypeStage, NameStage, IsCustomerStage, IsSupplierStage, AutoDebtReminderStage, IsEmployeeStage, IsGroupMemberStage, IsActiveStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1PartnersFindOrCreateResponsePartnerType type;
    ...
    private Optional<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass> legalCountryClass = Optional.empty();
    ...
    private Optional<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress> correspondenceAddress = Optional.empty();

    private Optional<PostV1PartnersFindOrCreateResponsePartnerAddress> address = Optional.empty();
    ...
    @java.lang.Override
    public Builder from(PostV1PartnersFindOrCreateResponsePartner other) {
      id(other.getId());
      type(other.getType());
      name(other.getName());
      code(other.getCode());
    ...
    @java.lang.Override
    @JsonSetter("type")
    public NameStage type(@NotNull PostV1PartnersFindOrCreateResponsePartnerType type) {
    ...
    @java.lang.Override
    public _FinalStage address(Nullable<PostV1PartnersFindOrCreateResponsePartnerAddress> address) {
      if (address.isNull()) {
        this.address = null;
      }
    ...
    @java.lang.Override
    public _FinalStage address(PostV1PartnersFindOrCreateResponsePartnerAddress address) {
    ...
    public _FinalStage address(Optional<PostV1PartnersFindOrCreateResponsePartnerAddress> address) {
      this.address = address;
      return this;
    }
