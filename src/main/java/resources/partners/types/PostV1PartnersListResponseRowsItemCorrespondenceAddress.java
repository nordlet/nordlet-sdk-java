...
@JsonDeserialize(
    builder = PostV1PartnersListResponseRowsItemCorrespondenceAddress.Builder.class
)
public final class PostV1PartnersListResponseRowsItemCorrespondenceAddress {
  ...
  private PostV1PartnersListResponseRowsItemCorrespondenceAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersListResponseRowsItemCorrespondenceAddress && equalTo((PostV1PartnersListResponseRowsItemCorrespondenceAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersListResponseRowsItemCorrespondenceAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersListResponseRowsItemCorrespondenceAddress other) {
    ...
    public PostV1PartnersListResponseRowsItemCorrespondenceAddress build() {
      return new PostV1PartnersListResponseRowsItemCorrespondenceAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
