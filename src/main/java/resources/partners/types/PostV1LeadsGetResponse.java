...
@JsonDeserialize(
    builder = PostV1LeadsGetResponse.Builder.class
)
public final class PostV1LeadsGetResponse {
  ...
  private final PostV1LeadsGetResponseStatus status;
  ...
  private PostV1LeadsGetResponse(String id, String name, Optional<String> contactName,
      ...
      PostV1LeadsGetResponseStatus status, Optional<String> estimatedValue, String currency,
  ...
  @JsonProperty("status")
  public PostV1LeadsGetResponseStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LeadsGetResponse && equalTo((PostV1LeadsGetResponse) other);
  }
  ...
  private boolean equalTo(PostV1LeadsGetResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1LeadsGetResponse other);
  }
  ...
  public interface StatusStage {
    CurrencyStage status(@NotNull PostV1LeadsGetResponseStatus status);
  }
  ...
  public static final class Builder implements IdStage, NameStage, StatusStage, CurrencyStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1LeadsGetResponseStatus status;
    ...
    @java.lang.Override
    public Builder from(PostV1LeadsGetResponse other) {
      id(other.getId());
      name(other.getName());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CurrencyStage status(@NotNull PostV1LeadsGetResponseStatus status) {
    ...
    @java.lang.Override
    public PostV1LeadsGetResponse build() {
      return new PostV1LeadsGetResponse(id, name, contactName, email, phone, website, countryCode, sourceId, sourceName, status, estimatedValue, currency, description, assignedUserId, partnerId, convertedAt, createdAt, updatedAt, additionalProperties);
    }
