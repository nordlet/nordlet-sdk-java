...
@JsonDeserialize(
    builder = PostV1PartnersCreateRequestAddress.Builder.class
)
public final class PostV1PartnersCreateRequestAddress {
  ...
  private PostV1PartnersCreateRequestAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersCreateRequestAddress && equalTo((PostV1PartnersCreateRequestAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersCreateRequestAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersCreateRequestAddress other) {
    ...
    public PostV1PartnersCreateRequestAddress build() {
      return new PostV1PartnersCreateRequestAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
