...
@JsonDeserialize(
    builder = PostV1PartnersUpdateResponseAddress.Builder.class
)
public final class PostV1PartnersUpdateResponseAddress {
  ...
  private PostV1PartnersUpdateResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersUpdateResponseAddress && equalTo((PostV1PartnersUpdateResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersUpdateResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersUpdateResponseAddress other) {
    ...
    public PostV1PartnersUpdateResponseAddress build() {
      return new PostV1PartnersUpdateResponseAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
