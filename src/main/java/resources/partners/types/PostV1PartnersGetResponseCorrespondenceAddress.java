...
@JsonDeserialize(
    builder = PostV1PartnersGetResponseCorrespondenceAddress.Builder.class
)
public final class PostV1PartnersGetResponseCorrespondenceAddress {
  ...
  private PostV1PartnersGetResponseCorrespondenceAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersGetResponseCorrespondenceAddress && equalTo((PostV1PartnersGetResponseCorrespondenceAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersGetResponseCorrespondenceAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersGetResponseCorrespondenceAddress other) {
    ...
    public PostV1PartnersGetResponseCorrespondenceAddress build() {
      return new PostV1PartnersGetResponseCorrespondenceAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
