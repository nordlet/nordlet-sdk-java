...
@JsonDeserialize(
    builder = PostV1PartnersCreateResponseAddress.Builder.class
)
public final class PostV1PartnersCreateResponseAddress {
  ...
  private PostV1PartnersCreateResponseAddress(Optional<String> street, Optional<String> city,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersCreateResponseAddress && equalTo((PostV1PartnersCreateResponseAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersCreateResponseAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersCreateResponseAddress other) {
    ...
    public PostV1PartnersCreateResponseAddress build() {
      return new PostV1PartnersCreateResponseAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
