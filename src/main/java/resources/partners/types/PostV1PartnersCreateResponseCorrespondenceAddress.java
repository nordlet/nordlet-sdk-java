...
@JsonDeserialize(
    builder = PostV1PartnersCreateResponseCorrespondenceAddress.Builder.class
)
public final class PostV1PartnersCreateResponseCorrespondenceAddress {
  ...
  private PostV1PartnersCreateResponseCorrespondenceAddress(Optional<String> street,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1PartnersCreateResponseCorrespondenceAddress && equalTo((PostV1PartnersCreateResponseCorrespondenceAddress) other);
  }
  ...
  private boolean equalTo(PostV1PartnersCreateResponseCorrespondenceAddress other) {
  ...
  public static final class Builder {
    ...
    public Builder from(PostV1PartnersCreateResponseCorrespondenceAddress other) {
    ...
    public PostV1PartnersCreateResponseCorrespondenceAddress build() {
      return new PostV1PartnersCreateResponseCorrespondenceAddress(street, city, municipality, county, postalCode, countryCode, additionalProperties);
    }
