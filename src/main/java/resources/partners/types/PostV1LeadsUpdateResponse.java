...
@JsonDeserialize(
    builder = PostV1LeadsUpdateResponse.Builder.class
)
public final class PostV1LeadsUpdateResponse {
  ...
  private final PostV1LeadsUpdateResponseStatus status;
  ...
  private PostV1LeadsUpdateResponse(String id, String name, Optional<String> contactName,
      ...
      PostV1LeadsUpdateResponseStatus status, Optional<String> estimatedValue, String currency,
  ...
  @JsonProperty("status")
  public PostV1LeadsUpdateResponseStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostV1LeadsUpdateResponse && equalTo((PostV1LeadsUpdateResponse) other);
  }
  ...
  private boolean equalTo(PostV1LeadsUpdateResponse other) {
  ...
  public interface IdStage {
    ...
    Builder from(PostV1LeadsUpdateResponse other);
  }
  ...
  public interface StatusStage {
    CurrencyStage status(@NotNull PostV1LeadsUpdateResponseStatus status);
  }
  ...
  public interface _FinalStage {
    PostV1LeadsUpdateResponse build();
  ...
  public static final class Builder implements IdStage, NameStage, StatusStage, CurrencyStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    private PostV1LeadsUpdateResponseStatus status;
    ...
    @java.lang.Override
    public Builder from(PostV1LeadsUpdateResponse other) {
      id(other.getId());
      name(other.getName());
    ...
    @java.lang.Override
    @JsonSetter("status")
    public CurrencyStage status(@NotNull PostV1LeadsUpdateResponseStatus status) {
    ...
    @java.lang.Override
    public PostV1LeadsUpdateResponse build() {
      return new PostV1LeadsUpdateResponse(id, name, contactName, email, phone, website, countryCode, sourceId, sourceName, status, estimatedValue, currency, description, assignedUserId, partnerId, convertedAt, createdAt, updatedAt, additionalProperties);
    }
