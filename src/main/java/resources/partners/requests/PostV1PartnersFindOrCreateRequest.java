...
public final class PostV1PartnersFindOrCreateRequest {
  ...
  public static final class Builder implements NameStage, _FinalStage {
    ...
    public PostV1PartnersFindOrCreateRequest build() {
      return new PostV1PartnersFindOrCreateRequest(type, name, code, vatCode, peppolId, email, phone, selfEmploymentCertNo, birthDate, isCustomer, isSupplier, paymentTermDays, creditLimit, priceListId, groupId, statusId, address, notes, documentRef, additionalProperties);
    }
