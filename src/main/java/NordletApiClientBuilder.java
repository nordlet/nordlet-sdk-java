...
public class NordletApiClientBuilder {
   ...
   * Sets token
   */
  public NordletApiClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public NordletApiClientBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public NordletApiClientBuilder url(String url) {
   ...
   */
  public NordletApiClientBuilder timeout(int timeout) {
   ...
   */
  public NordletApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public NordletApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
   ...
   */
  public NordletApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
   ...
   */
  public NordletApiClientBuilder retryJitterFactor(double retryJitterFactor) {
   ...
   */
  public NordletApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public NordletApiClientBuilder logging(LogConfig logging) {
   ...
   */
  public NordletApiClientBuilder addHeader(String name, String value) {
  ...
  public NordletApiClient build() {
    if (token == null) {
      throw new RuntimeException("Please provide token");
    }
    validateConfiguration();
    return new NordletApiClient(buildClientOptions());
  }
}
