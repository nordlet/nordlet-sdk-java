# Nordlet Java Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Nordlet%2FJava)

The Nordlet Java library provides convenient access to the Nordlet APIs from Java.
...
A full reference for this library is available [here](https://github.com/nordlet/nordlet-sdk-java/blob/main/reference.md).
...
public class Example {
    public static void main(String[] args) {
        NordletApiClient client = NordletApiClient
            .builder()
            .token("<token>")
            .build();
...
```java
import com.nordlet.api.NordletApiClient;
import com.nordlet.api.core.Environment;
